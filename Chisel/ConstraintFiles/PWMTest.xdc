...
## Switches
set_property PACKAGE_PIN V17 [get_ports io_brake]
...
set_property PACKAGE_PIN V7 [get_ports {io_seg[7]}]
...
##Pmod Header JA
#set_property PACKAGE_PIN J1 [get_ports io_pwmOut]
...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports io_T1];#Sch name = XA1_P
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports io_T2];#Sch name = XA2_P
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports io_T3];#Sch name = XA3_P
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports io_T4];#Sch name = XA4_P
