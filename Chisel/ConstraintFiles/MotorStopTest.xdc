...
## Switches
set_property PACKAGE_PIN V17 [get_ports io_over_current_pos]
set_property PACKAGE_PIN V16 [get_ports io_over_current_neg]
...
##Pmod Header JXADC
set_property PACKAGE_PIN J3 [get_ports io_T1]
set_property PACKAGE_PIN L3 [get_ports io_T2]
set_property PACKAGE_PIN M2 [get_ports io_T3]
set_property PACKAGE_PIN N2 [get_ports io_T4]
