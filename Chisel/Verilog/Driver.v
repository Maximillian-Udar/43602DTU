...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [26:0] grace_timer; // @[\\src\\main\\scala\\Driver.scala 144:28]
  wire  _T_17 = grace_timer < 27'h5f5e100; // @[\\src\\main\\scala\\Driver.scala 148:26]
  wire [26:0] _grace_timer_T_1 = grace_timer + 27'h1; // @[\\src\\main\\scala\\Driver.scala 149:32]
  reg [25:0] stillness_timer; // @[\\src\\main\\scala\\Driver.scala 156:32]
  wire [25:0] _stillness_timer_T_1 = stillness_timer + 26'h1; // @[\\src\\main\\scala\\Driver.scala 161:40]
  wire  motor_is_still = stillness_timer == 26'h2faf080; // @[\\src\\main\\scala\\Driver.scala 164:40]
  ...
  wire [37:0] _in_tolerance_zone_T_2 = $signed(target_turns) - 38'sh1; // @[\\src\\main\\scala\\Driver.scala 170:58]
  wire [37:0] _GEN_154 = {{6{current_turns[31]}},current_turns}; // @[\\src\\main\\scala\\Driver.scala 170:42]
  wire [37:0] _in_tolerance_zone_T_6 = $signed(target_turns) + 38'sh1; // @[\\src\\main\\scala\\Driver.scala 171:58]
  wire  _in_tolerance_zone_T_7 = $signed(_GEN_154) <= $signed(_in_tolerance_zone_T_6); // @[\\src\\main\\scala\\Driver.scala 171:42]
  wire  _in_tolerance_zone_T_8 = $signed(_GEN_154) >= $signed(_in_tolerance_zone_T_2) & _in_tolerance_zone_T_7; // @[\\src\\main\\scala\\Driver.scala 170:70]
  ...
  wire  at_position = in_tolerance_zone & ($signed(_GEN_154) == $signed(target_turns) | motor_is_still); // @[\\src\\main\\scala\\Driver.scala 173:39]
  wire [31:0] raw_pid_out = pid_io_controlOut; // @[\\src\\main\\scala\\Driver.scala 184:39]
  wire [27:0] _pid_offset_T_2 = raw_pid_out[31:4]; // @[\\src\\main\\scala\\Driver.scala 189:94]
  wire [27:0] _pid_offset_T_5 = $signed(_pid_offset_T_2) + 28'sh50; // @[\\src\\main\\scala\\Driver.scala 189:100]
  wire [28:0] _pid_offset_T_6 = raw_pid_out[31:3]; // @[\\src\\main\\scala\\Driver.scala 189:121]
  wire [28:0] _pid_offset_T_9 = $signed(_pid_offset_T_6) - 29'shf; // @[\\src\\main\\scala\\Driver.scala 189:127]
  reg [28:0] pid_offset; // @[\\src\\main\\scala\\Driver.scala 189:27]
  wire [28:0] pid_duty_raw = 29'sh200 + $signed(pid_offset); // @[\\src\\main\\scala\\Driver.scala 191:28]
  wire [28:0] _pid_duty_T_2 = 29'sh200 + $signed(pid_offset); // @[\\src\\main\\scala\\Driver.scala 192:119]
  wire [28:0] _pid_duty_T_3 = $signed(pid_duty_raw) < 29'sh0 ? 29'h0 : _pid_duty_T_2; // @[\\src\\main\\scala\\Driver.scala 192:80]
  wire [28:0] _pid_duty_T_4 = $signed(pid_duty_raw) > 29'sh3ff ? 29'h3ff : _pid_duty_T_3; // @[\\src\\main\\scala\\Driver.scala 192:45]
  wire [28:0] pid_duty = at_position ? 29'h200 : _pid_duty_T_4; // @[\\src\\main\\scala\\Driver.scala 192:21]
  wire [28:0] active_duty = control_mode ? pid_duty : {{19'd0}, manual_ramped}; // @[\\src\\main\\scala\\Driver.scala 194:24]
  wire  is_moving_back = active_duty < 29'h200; // @[\\src\\main\\scala\\Driver.scala 195:36]
  wire  is_moving_fwd = active_duty > 29'h200; // @[\\src\\main\\scala\\Driver.scala 196:35]
  wire  block_neg = system_active & $signed(current_position_cm) <= 20'sh0 & is_moving_back; // @[\\src\\main\\scala\\Driver.scala 198:75]
  wire  block_pos = system_active & $signed(current_position_cm) >= 20'sh5a & is_moving_fwd; // @[\\src\\main\\scala\\Driver.scala 199:76]
  wire  active_stuck = ~io_detector_toggle ? encoder_stuck_io_motor_disable : stuck_detector_io_motor_disable; // @[\\src\\main\\scala\\Driver.scala 207:25]
  reg [28:0] pwm_signal_io_duty_cycle_REG; // @[\\src\\main\\scala\\Driver.scala 210:38]
  wire  motor_stopped = manual_brake | _T_2 | at_position | block_neg | block_pos | active_stuck; // @[\\src\\main\\scala\\Driver.scala 211:95]
  reg [23:0] txTimer; // @[\\src\\main\\scala\\Driver.scala 227:24]
  reg [2:0] txState; // @[\\src\\main\\scala\\Driver.scala 229:24]
  wire  _T_23 = ~tx_io_busy; // @[\\src\\main\\scala\\Driver.scala 235:14]
  wire [7:0] _GEN_95 = ~tx_io_busy ? 8'hff : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 235:27 236:22]
  wire [7:0] _GEN_98 = _T_23 ? current_position_cm[15:8] : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 241:27 242:22]
  wire [2:0] _GEN_100 = _T_23 ? 3'h2 : txState; // @[\\src\\main\\scala\\Driver.scala 241:27 244:19 229:24]
  wire [23:0] _GEN_101 = _T_23 ? 24'h0 : txTimer; // @[\\src\\main\\scala\\Driver.scala 241:27 245:19 227:24]
  wire [7:0] _GEN_102 = _T_23 ? current_position_cm[7:0] : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 248:27 249:22]
  wire [2:0] _GEN_104 = _T_23 ? 3'h3 : txState; // @[\\src\\main\\scala\\Driver.scala 248:27 251:19 229:24]
  wire [7:0] _GEN_106 = _T_23 ? rotations_io_total_rotations[31:24] : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 255:27 256:22]
  wire [2:0] _GEN_108 = _T_23 ? 3'h4 : txState; // @[\\src\\main\\scala\\Driver.scala 255:27 258:19 229:24]
  wire [7:0] _GEN_110 = _T_23 ? rotations_io_total_rotations[23:16] : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 262:27 263:22]
  wire [2:0] _GEN_112 = _T_23 ? 3'h5 : txState; // @[\\src\\main\\scala\\Driver.scala 262:27 265:19 229:24]
  wire [7:0] _GEN_114 = _T_23 ? rotations_io_total_rotations[15:8] : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 269:27 270:22]
  wire [2:0] _GEN_116 = _T_23 ? 3'h6 : txState; // @[\\src\\main\\scala\\Driver.scala 269:27 272:19 229:24]
  wire [7:0] _GEN_118 = _T_23 ? rotations_io_total_rotations[7:0] : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 276:27 277:22]
  wire [2:0] _GEN_120 = _T_23 ? 3'h0 : txState; // @[\\src\\main\\scala\\Driver.scala 276:27 279:19 229:24]
  wire [7:0] _GEN_122 = 3'h6 == txState ? _GEN_118 : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 233:21]
  wire  _GEN_123 = 3'h6 == txState & _T_23; // @[\\src\\main\\scala\\Driver.scala 231:15 233:21]
  wire [2:0] _GEN_124 = 3'h6 == txState ? _GEN_120 : txState; // @[\\src\\main\\scala\\Driver.scala 233:21 229:24]
  wire [23:0] _GEN_125 = 3'h6 == txState ? _GEN_101 : txTimer; // @[\\src\\main\\scala\\Driver.scala 233:21 227:24]
  wire [7:0] _GEN_126 = 3'h5 == txState ? _GEN_114 : _GEN_122; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire  _GEN_127 = 3'h5 == txState ? _T_23 : _GEN_123; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [2:0] _GEN_128 = 3'h5 == txState ? _GEN_116 : _GEN_124; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [23:0] _GEN_129 = 3'h5 == txState ? _GEN_101 : _GEN_125; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [7:0] _GEN_130 = 3'h4 == txState ? _GEN_110 : _GEN_126; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire  _GEN_131 = 3'h4 == txState ? _T_23 : _GEN_127; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [2:0] _GEN_132 = 3'h4 == txState ? _GEN_112 : _GEN_128; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [23:0] _GEN_133 = 3'h4 == txState ? _GEN_101 : _GEN_129; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [7:0] _GEN_134 = 3'h3 == txState ? _GEN_106 : _GEN_130; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire  _GEN_135 = 3'h3 == txState ? _T_23 : _GEN_131; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [2:0] _GEN_136 = 3'h3 == txState ? _GEN_108 : _GEN_132; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [23:0] _GEN_137 = 3'h3 == txState ? _GEN_101 : _GEN_133; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [7:0] _GEN_138 = 3'h2 == txState ? _GEN_102 : _GEN_134; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire  _GEN_139 = 3'h2 == txState ? _T_23 : _GEN_135; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [2:0] _GEN_140 = 3'h2 == txState ? _GEN_104 : _GEN_136; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [23:0] _GEN_141 = 3'h2 == txState ? _GEN_101 : _GEN_137; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [7:0] _GEN_142 = 3'h1 == txState ? _GEN_98 : _GEN_138; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire  _GEN_143 = 3'h1 == txState ? _T_23 : _GEN_139; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [7:0] _GEN_146 = 3'h0 == txState ? _GEN_95 : _GEN_142; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire  _GEN_147 = 3'h0 == txState ? _T_23 : _GEN_143; // @[\\src\\main\\scala\\Driver.scala 233:21]
  wire [23:0] _txTimer_T_1 = txTimer + 24'h1; // @[\\src\\main\\scala\\Driver.scala 283:36]
  wire [18:0] _display_io_disp_content_T = control_mode ? 19'h57797 : 19'h56ade; // @[\\src\\main\\scala\\Driver.scala 298:33]
  wire [19:0] _display_io_disp_content_T_1 = motor_stopped ? 20'hdf2f8 : {{1'd0}, _display_io_disp_content_T}; // @[\\src\\main\\scala\\Driver.scala 297:33]
  wire [43:0] _GEN_157 = {$signed(target_position_cm), 12'h0}; // @[\\src\\main\\scala\\Driver.scala 176:19]
  ...
  assign io_uart_tx = tx_io_tx; // @[\\src\\main\\scala\\Driver.scala 284:14]
  assign io_T1 = _T_2 ? 1'h0 : pwm_signal_io_T1; // @[\\src\\main\\scala\\Driver.scala 214:25 215:11 220:11]
  assign io_T2 = _T_2 | pwm_signal_io_T2; // @[\\src\\main\\scala\\Driver.scala 214:25 216:11 221:11]
  assign io_T3 = _T_2 ? 1'h0 : pwm_signal_io_T3; // @[\\src\\main\\scala\\Driver.scala 214:25 217:11 222:11]
  assign io_T4 = _T_2 | pwm_signal_io_T4; // @[\\src\\main\\scala\\Driver.scala 214:25 218:11 223:11]
  assign io_seg = display_io_seg; // @[\\src\\main\\scala\\Driver.scala 289:34]
  assign io_an = display_io_an; // @[\\src\\main\\scala\\Driver.scala 289:9]
  assign rx_clock = clock;
  assign rx_reset = reset;
  assign rx_io_rx = io_uart_rx; // @[\\src\\main\\scala\\Driver.scala 45:34]
  assign tx_clock = clock;
  assign tx_reset = reset;
  assign tx_io_data = txTimer >= 24'h2625a0 ? _GEN_146 : 8'h0; // @[\\src\\main\\scala\\Driver.scala 230:14 232:30]
  assign tx_io_start = txTimer >= 24'h2625a0 & _GEN_147; // @[\\src\\main\\scala\\Driver.scala 231:15 232:30]
  assign pwm_signal_clock = clock;
  assign pwm_signal_reset = reset;
  assign pwm_signal_io_duty_cycle = pwm_signal_io_duty_cycle_REG[9:0]; // @[\\src\\main\\scala\\Driver.scala 210:28]
  assign pwm_signal_io_brake = manual_brake | _T_2 | at_position | block_neg | block_pos | active_stuck; // @[\\src\\main\\scala\\Driver.scala 211:95]
  assign pid_clock = clock;
  assign pid_reset = reset;
  assign pid_io_setPoint = _GEN_157[31:0]; // @[\\src\\main\\scala\\Driver.scala 176:19]
  assign pid_io_measuredVal = current_position_fixed_point; // @[\\src\\main\\scala\\Driver.scala 175:22]
  assign pid_io_tick = pid_timer == 17'h1869f; // @[\\src\\main\\scala\\Driver.scala 54:29]
  assign pid_io_resetBuffer = ~control_mode | manual_brake | _T_2 | at_position; // @[\\src\\main\\scala\\Driver.scala 178:73]
  ...
  assign display_io_disp_content = stuck_detector_io_motor_disable ? 20'h7af9e : _display_io_disp_content_T_1; // @[\\src\\main\\scala\\Driver.scala 296:33]
  ...
  assign encoder_stuck_io_moving_requested = system_active & ~at_position & ~manual_brake & active_duty != 29'h200 & ~
    _T_17; // @[\\src\\main\\scala\\Driver.scala 203:94]
  assign encoder_stuck_io_pulse_detected = rotations_io_pulse; // @[\\src\\main\\scala\\Driver.scala 205:35]
  assign encoder_stuck_io_clear_shutdown = error_clear_debounce_io_out | reset_triggered; // @[\\src\\main\\scala\\Driver.scala 206:69]
  always @(posedge clock) begin
    ...
    if (reset) begin // @[\\src\\main\\scala\\Driver.scala 144:28]
      grace_timer <= 27'h5f5e100; // @[\\src\\main\\scala\\Driver.scala 144:28]
    end else if (new_cmd_pulse) begin // @[\\src\\main\\scala\\Driver.scala 146:23]
      grace_timer <= 27'h0; // @[\\src\\main\\scala\\Driver.scala 147:17]
    end else if (grace_timer < 27'h5f5e100) begin // @[\\src\\main\\scala\\Driver.scala 148:41]
      grace_timer <= _grace_timer_T_1; // @[\\src\\main\\scala\\Driver.scala 149:17]
    end
    if (reset) begin // @[\\src\\main\\scala\\Driver.scala 156:32]
      stillness_timer <= 26'h0; // @[\\src\\main\\scala\\Driver.scala 156:32]
    end else if (rotations_io_pulse | new_cmd_pulse) begin // @[\\src\\main\\scala\\Driver.scala 158:45]
      stillness_timer <= 26'h0; // @[\\src\\main\\scala\\Driver.scala 159:21]
    end else if (stillness_timer < 26'h2faf080) begin // @[\\src\\main\\scala\\Driver.scala 160:49]
      stillness_timer <= _stillness_timer_T_1; // @[\\src\\main\\scala\\Driver.scala 161:21]
    end
    target_turns <= $signed(_target_turns_T) / 3'sh2; // @[\\src\\main\\scala\\Driver.scala 167:58]
    if ($signed(raw_pid_out) == 32'sh0) begin // @[\\src\\main\\scala\\Driver.scala 189:31]
      pid_offset <= 29'sh0;
    end else if ($signed(raw_pid_out) > 32'sh0) begin // @[\\src\\main\\scala\\Driver.scala 189:61]
      pid_offset <= {{1{_pid_offset_T_5[27]}},_pid_offset_T_5};
    end else begin
      pid_offset <= _pid_offset_T_9;
    end
    if (reset) begin // @[\\src\\main\\scala\\Driver.scala 210:38]
      pwm_signal_io_duty_cycle_REG <= 29'h200; // @[\\src\\main\\scala\\Driver.scala 210:38]
    end else if (block_neg | block_pos) begin // @[\\src\\main\\scala\\Driver.scala 210:42]
      pwm_signal_io_duty_cycle_REG <= 29'h200;
    end else if (control_mode) begin // @[\\src\\main\\scala\\Driver.scala 194:24]
      if (at_position) begin // @[\\src\\main\\scala\\Driver.scala 192:21]
        pwm_signal_io_duty_cycle_REG <= 29'h200;
      end else begin
    ...
    if (reset) begin // @[\\src\\main\\scala\\Driver.scala 227:24]
      txTimer <= 24'h0; // @[\\src\\main\\scala\\Driver.scala 227:24]
    end else if (txTimer >= 24'h2625a0) begin // @[\\src\\main\\scala\\Driver.scala 232:30]
      if (!(3'h0 == txState)) begin // @[\\src\\main\\scala\\Driver.scala 233:21]
        if (3'h1 == txState) begin // @[\\src\\main\\scala\\Driver.scala 233:21]
          txTimer <= _GEN_101;
        end else begin
          txTimer <= _GEN_141;
        end
      ...
      txTimer <= _txTimer_T_1; // @[\\src\\main\\scala\\Driver.scala 283:25]
    end
    if (reset) begin // @[\\src\\main\\scala\\Driver.scala 229:24]
      txState <= 3'h0; // @[\\src\\main\\scala\\Driver.scala 229:24]
    end else if (txTimer >= 24'h2625a0) begin // @[\\src\\main\\scala\\Driver.scala 232:30]
      if (3'h0 == txState) begin // @[\\src\\main\\scala\\Driver.scala 233:21]
        if (~tx_io_busy) begin // @[\\src\\main\\scala\\Driver.scala 235:27]
          txState <= 3'h1; // @[\\src\\main\\scala\\Driver.scala 238:19]
        end
      end else if (3'h1 == txState) begin // @[\\src\\main\\scala\\Driver.scala 233:21]
        txState <= _GEN_100;
      end else begin
        txState <= _GEN_140;
      end
