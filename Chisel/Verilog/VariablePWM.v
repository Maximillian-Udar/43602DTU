...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [3:0] _currentDot_T = 4'h4 >> digit; // @[\\src\\main\\scala\\DispMux.scala 36:27]
...
module VariablePWM(
  input        clock,
  input        reset,
  input        io_switch_state, // @[\\src\\main\\scala\\DCMotorPWM.scala 6:14]
  output       io_pwmOutPos, // @[\\src\\main\\scala\\DCMotorPWM.scala 6:14]
  output       io_pwmOutNeg, // @[\\src\\main\\scala\\DCMotorPWM.scala 6:14]
  output [7:0] io_seg, // @[\\src\\main\\scala\\DCMotorPWM.scala 6:14]
  output [3:0] io_an // @[\\src\\main\\scala\\DCMotorPWM.scala 6:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
`endif // RANDOMIZE_REG_INIT
  wire  input_debounce_clock; // @[\\src\\main\\scala\\DCMotorPWM.scala 19:30]
  wire  input_debounce_reset; // @[\\src\\main\\scala\\DCMotorPWM.scala 19:30]
  wire  input_debounce_io_btn_in; // @[\\src\\main\\scala\\DCMotorPWM.scala 19:30]
  wire  input_debounce_io_out; // @[\\src\\main\\scala\\DCMotorPWM.scala 19:30]
  wire  rising_edge_clock; // @[\\src\\main\\scala\\DCMotorPWM.scala 20:30]
  wire  rising_edge_reset; // @[\\src\\main\\scala\\DCMotorPWM.scala 20:30]
  wire  rising_edge_io_din; // @[\\src\\main\\scala\\DCMotorPWM.scala 20:30]
  wire  rising_edge_io_risingEdge; // @[\\src\\main\\scala\\DCMotorPWM.scala 20:30]
  ...
  reg [2:0] stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 29:25]
  wire  _T_2 = 3'h0 == stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
  wire  _T_5 = 3'h1 == stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
  wire  _T_8 = 3'h2 == stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
  wire  _T_11 = 3'h3 == stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
  wire  _T_14 = 3'h4 == stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
  wire [2:0] _GEN_0 = 3'h4 == stateReg ? 3'h0 : stateReg; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23 29:25 37:33]
  wire [2:0] _GEN_1 = 3'h3 == stateReg ? 3'h4 : _GEN_0; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23 36:33]
  wire [2:0] _GEN_2 = 3'h2 == stateReg ? 3'h3 : _GEN_1; // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23 35:33]
  wire [11:0] _GEN_6 = _T_14 ? 12'hbb7 : 12'h0; // @[\\src\\main\\scala\\DCMotorPWM.scala 42:13 48:21 70:17]
  wire [4:0] _GEN_7 = _T_14 ? 5'h9 : 5'h0; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 71:10 44:27]
  wire [11:0] _GEN_9 = _T_11 ? 12'h9c3 : _GEN_6; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 65:17]
  wire [4:0] _GEN_10 = _T_11 ? 5'h7 : _GEN_7; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 66:10]
  wire [4:0] _GEN_11 = _T_11 ? 5'h5 : 5'h0; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 67:10]
  wire [11:0] _GEN_12 = _T_8 ? 12'h682 : _GEN_9; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 60:17]
  wire [4:0] _GEN_13 = _T_8 ? 5'h5 : _GEN_10; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 61:10]
  wire [4:0] _GEN_14 = _T_8 ? 5'h0 : _GEN_11; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 62:10]
  wire [11:0] _GEN_15 = _T_5 ? 12'h341 : _GEN_12; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 55:17]
  wire [4:0] _GEN_16 = _T_5 ? 5'h2 : _GEN_13; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 56:10]
  wire [4:0] _GEN_17 = _T_5 ? 5'h5 : _GEN_14; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 57:10]
  wire [11:0] dutyCycle = _T_2 ? 12'h14d : _GEN_15; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 50:17]
  wire [4:0] d2 = _T_2 ? 5'h1 : _GEN_16; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 51:10]
  wire [4:0] d1 = _T_2 ? 5'h0 : _GEN_17; // @[\\src\\main\\scala\\DCMotorPWM.scala 48:21 52:10]
  wire [9:0] displayMux_io_disp_content_lo = {d1,5'h1d}; // @[\\src\\main\\scala\\DCMotorPWM.scala 77:36]
  wire [9:0] displayMux_io_disp_content_hi = {5'h0,d2}; // @[\\src\\main\\scala\\DCMotorPWM.scala 77:36]
  reg [11:0] pwmCounter; // @[\\src\\main\\scala\\DCMotorPWM.scala 82:27]
  wire [11:0] _pwmCounter_T_1 = pwmCounter + 12'h1; // @[\\src\\main\\scala\\DCMotorPWM.scala 87:30]
  wire  _io_pwmOutPos_T = pwmCounter < dutyCycle; // @[\\src\\main\\scala\\DCMotorPWM.scala 90:30]
  Debouncer input_debounce ( // @[\\src\\main\\scala\\DCMotorPWM.scala 19:30]
    .clock(input_debounce_clock),
    .reset(input_debounce_reset),
    .io_btn_in(input_debounce_io_btn_in),
    .io_out(input_debounce_io_out)
  );
  RisingFsm rising_edge ( // @[\\src\\main\\scala\\DCMotorPWM.scala 20:30]
  ...
  assign io_pwmOutPos = pwmCounter < dutyCycle; // @[\\src\\main\\scala\\DCMotorPWM.scala 90:30]
  assign io_pwmOutNeg = ~_io_pwmOutPos_T; // @[\\src\\main\\scala\\DCMotorPWM.scala 91:19]
  assign io_seg = displayMux_io_seg; // @[\\src\\main\\scala\\DCMotorPWM.scala 79:10]
  assign io_an = displayMux_io_an; // @[\\src\\main\\scala\\DCMotorPWM.scala 80:10]
  assign input_debounce_clock = clock;
  assign input_debounce_reset = reset;
  assign input_debounce_io_btn_in = io_switch_state; // @[\\src\\main\\scala\\DCMotorPWM.scala 22:28]
  assign rising_edge_clock = clock;
  assign rising_edge_reset = reset;
  assign rising_edge_io_din = input_debounce_io_out; // @[\\src\\main\\scala\\DCMotorPWM.scala 23:28]
  assign displayMux_clock = clock;
  assign displayMux_reset = reset;
  assign displayMux_io_disp_content = {displayMux_io_disp_content_hi,displayMux_io_disp_content_lo}; // @[\\src\\main\\scala\\DCMotorPWM.scala 77:36]
  always @(posedge clock) begin
    if (reset) begin // @[\\src\\main\\scala\\DCMotorPWM.scala 29:25]
      stateReg <= 3'h2; // @[\\src\\main\\scala\\DCMotorPWM.scala 29:25]
    end else if (rising_edge_io_risingEdge) begin // @[\\src\\main\\scala\\DCMotorPWM.scala 31:15]
      if (3'h0 == stateReg) begin // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
        stateReg <= 3'h1; // @[\\src\\main\\scala\\DCMotorPWM.scala 33:33]
      end else if (3'h1 == stateReg) begin // @[\\src\\main\\scala\\DCMotorPWM.scala 32:23]
        stateReg <= 3'h2; // @[\\src\\main\\scala\\DCMotorPWM.scala 34:33]
      end else begin
        stateReg <= _GEN_2;
      end
    end
    if (reset) begin // @[\\src\\main\\scala\\DCMotorPWM.scala 82:27]
      pwmCounter <= 12'h0; // @[\\src\\main\\scala\\DCMotorPWM.scala 82:27]
    end else if (pwmCounter == 12'hd04) begin // @[\\src\\main\\scala\\DCMotorPWM.scala 84:46]
      pwmCounter <= 12'h0; // @[\\src\\main\\scala\\DCMotorPWM.scala 85:16]
    end else begin
      pwmCounter <= _pwmCounter_T_1; // @[\\src\\main\\scala\\DCMotorPWM.scala 87:16]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
