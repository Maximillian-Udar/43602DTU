...
module PIDController(
  input         clock,
  input         reset,
  input  [31:0] io_setPoint, // @[\\src\\main\\scala\\Functions.scala 71:14]
  input  [31:0] io_measuredVal, // @[\\src\\main\\scala\\Functions.scala 71:14]
  input         io_resetBuffer, // @[\\src\\main\\scala\\Functions.scala 71:14]
  output [31:0] io_controlOut // @[\\src\\main\\scala\\Functions.scala 71:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
  ...
  reg [63:0] _RAND_7;
`endif // RANDOMIZE_REG_INIT
  reg [31:0] integralReg; // @[\\src\\main\\scala\\Functions.scala 82:29]
  reg [31:0] prevErrorReg; // @[\\src\\main\\scala\\Functions.scala 83:29]
  reg [31:0] outputReg; // @[\\src\\main\\scala\\Functions.scala 84:29]
  wire [31:0] error = $signed(io_setPoint) - $signed(io_measuredVal); // @[\\src\\main\\scala\\Functions.scala 89:27]
  ...
  wire [31:0] _dTerm_T_2 = $signed(error) - $signed(prevErrorReg); // @[\\src\\main\\scala\\Functions.scala 102:40]
  reg [63:0] dTerm; // @[\\src\\main\\scala\\Functions.scala 102:24]
  wire [63:0] _rawOutput_T_2 = $signed(pTerm) + $signed(_GEN_7); // @[\\src\\main\\scala\\Functions.scala 105:35]
  reg [63:0] rawOutput; // @[\\src\\main\\scala\\Functions.scala 105:28]
  wire [63:0] _outputReg_T_2 = $signed(rawOutput) < -64'sh800000 ? $signed(-64'sh800000) : $signed(rawOutput); // @[\\src\\main\\scala\\Functions.scala 107:21]
  wire [63:0] _outputReg_T_3 = $signed(rawOutput) > 64'sh800000 ? $signed(64'sh800000) : $signed(_outputReg_T_2); // @[\\src\\main\\scala\\Functions.scala 106:21]
  wire [63:0] _GEN_3 = io_resetBuffer ? $signed(64'sh0) : $signed(_integralReg_T_3); // @[\\src\\main\\scala\\Functions.scala 91:24 92:18]
  wire [63:0] _GEN_5 = io_resetBuffer ? $signed(64'sh0) : $signed(_outputReg_T_3); // @[\\src\\main\\scala\\Functions.scala 91:24 94:18]
  wire [51:0] _GEN_10 = reset ? $signed(52'sh0) : $signed(_GEN_3[63:12]); // @[\\src\\main\\scala\\Functions.scala 82:{29,29}]
  wire [51:0] _GEN_12 = reset ? $signed(52'sh0) : $signed(_GEN_5[63:12]); // @[\\src\\main\\scala\\Functions.scala 84:{29,29}]
  assign io_controlOut = outputReg; // @[\\src\\main\\scala\\Functions.scala 109:17]
  always @(posedge clock) begin
    integralReg <= _GEN_10[31:0]; // @[\\src\\main\\scala\\Functions.scala 82:{29,29}]
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 83:29]
      prevErrorReg <= 32'sh0; // @[\\src\\main\\scala\\Functions.scala 83:29]
    end else if (io_resetBuffer) begin // @[\\src\\main\\scala\\Functions.scala 91:24]
      prevErrorReg <= 32'sh0; // @[\\src\\main\\scala\\Functions.scala 93:18]
    end else begin
      prevErrorReg <= error;
    end
    outputReg <= _GEN_12[31:0]; // @[\\src\\main\\scala\\Functions.scala 84:{29,29}]
    ...
    dTerm <= 32'sh19a * $signed(_dTerm_T_2); // @[\\src\\main\\scala\\Functions.scala 102:31]
    rawOutput <= $signed(_rawOutput_T_2) + $signed(dTerm); // @[\\src\\main\\scala\\Functions.scala 105:49]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
module StuckDetector(
  input   clock,
  input   reset,
  input   io_external_overcurrent_input, // @[\\src\\main\\scala\\Functions.scala 158:14]
  input   io_clear_shutdown, // @[\\src\\main\\scala\\Functions.scala 158:14]
  output  io_motor_disable // @[\\src\\main\\scala\\Functions.scala 158:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
`endif // RANDOMIZE_REG_INIT
  wire [24:0] maxCycles = 17'h186a0 * 8'h96; // @[\\src\\main\\scala\\Functions.scala 164:44]
  reg [31:0] durationReg; // @[\\src\\main\\scala\\Functions.scala 165:28]
  reg  isStuckReg; // @[\\src\\main\\scala\\Functions.scala 166:28]
  wire [31:0] _GEN_8 = {{7'd0}, maxCycles}; // @[\\src\\main\\scala\\Functions.scala 170:26]
  wire [31:0] _durationReg_T_1 = durationReg + 32'h1; // @[\\src\\main\\scala\\Functions.scala 170:104]
  wire  _GEN_0 = durationReg >= _GEN_8 | isStuckReg; // @[\\src\\main\\scala\\Functions.scala 166:28 170:{40,53}]
  wire [31:0] _GEN_1 = durationReg >= _GEN_8 ? durationReg : _durationReg_T_1; // @[\\src\\main\\scala\\Functions.scala 165:28 170:{40,89}]
  assign io_motor_disable = isStuckReg; // @[\\src\\main\\scala\\Functions.scala 174:20]
  always @(posedge clock) begin
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 165:28]
      durationReg <= 32'h0; // @[\\src\\main\\scala\\Functions.scala 165:28]
    end else if (io_clear_shutdown) begin // @[\\src\\main\\scala\\Functions.scala 167:27]
      durationReg <= 32'h0; // @[\\src\\main\\scala\\Functions.scala 167:64]
    end else if (~isStuckReg) begin // @[\\src\\main\\scala\\Functions.scala 168:23]
      if (io_external_overcurrent_input) begin // @[\\src\\main\\scala\\Functions.scala 169:43]
        durationReg <= _GEN_1;
      end else begin
        durationReg <= 32'h0; // @[\\src\\main\\scala\\Functions.scala 171:33]
      end
    end
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 166:28]
      isStuckReg <= 1'h0; // @[\\src\\main\\scala\\Functions.scala 166:28]
    end else if (io_clear_shutdown) begin // @[\\src\\main\\scala\\Functions.scala 167:27]
      isStuckReg <= 1'h0; // @[\\src\\main\\scala\\Functions.scala 167:40]
    end else if (~isStuckReg) begin // @[\\src\\main\\scala\\Functions.scala 168:23]
      if (io_external_overcurrent_input) begin // @[\\src\\main\\scala\\Functions.scala 169:43]
        isStuckReg <= _GEN_0;
      end
...
module SevenSegDec(
  input  [4:0] io_in, // @[\\src\\main\\scala\\Functions.scala 226:14]
  output [6:0] io_out // @[\\src\\main\\scala\\Functions.scala 226:14]
);
  wire [6:0] _io_out_T_33 = 5'h0 == io_in ? 7'h3f : 7'h0; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_35 = 5'h1 == io_in ? 7'h6 : _io_out_T_33; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_37 = 5'h2 == io_in ? 7'h5b : _io_out_T_35; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_39 = 5'h3 == io_in ? 7'h4f : _io_out_T_37; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_41 = 5'h4 == io_in ? 7'h66 : _io_out_T_39; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_43 = 5'h5 == io_in ? 7'h6d : _io_out_T_41; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_45 = 5'h6 == io_in ? 7'h7d : _io_out_T_43; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_47 = 5'h7 == io_in ? 7'h7 : _io_out_T_45; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_49 = 5'h8 == io_in ? 7'h7f : _io_out_T_47; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_51 = 5'h9 == io_in ? 7'h6f : _io_out_T_49; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_53 = 5'ha == io_in ? 7'h77 : _io_out_T_51; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_55 = 5'hb == io_in ? 7'h7c : _io_out_T_53; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_57 = 5'hc == io_in ? 7'h39 : _io_out_T_55; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_59 = 5'hd == io_in ? 7'h5e : _io_out_T_57; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_61 = 5'he == io_in ? 7'h79 : _io_out_T_59; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_63 = 5'hf == io_in ? 7'h71 : _io_out_T_61; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_65 = 5'h10 == io_in ? 7'h3c : _io_out_T_63; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_67 = 5'h11 == io_in ? 7'h76 : _io_out_T_65; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_69 = 5'h12 == io_in ? 7'h6 : _io_out_T_67; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_71 = 5'h13 == io_in ? 7'hf : _io_out_T_69; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_73 = 5'h14 == io_in ? 7'h38 : _io_out_T_71; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_75 = 5'h15 == io_in ? 7'h38 : _io_out_T_73; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_77 = 5'h16 == io_in ? 7'h70 : _io_out_T_75; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_79 = 5'h17 == io_in ? 7'h3f : _io_out_T_77; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_81 = 5'h18 == io_in ? 7'h73 : _io_out_T_79; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_83 = 5'h19 == io_in ? 7'h67 : _io_out_T_81; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_85 = 5'h1a == io_in ? 7'h31 : _io_out_T_83; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_87 = 5'h1b == io_in ? 7'h6d : _io_out_T_85; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_89 = 5'h1c == io_in ? 7'h78 : _io_out_T_87; // @[\\src\\main\\scala\\Functions.scala 231:46]
  wire [6:0] _io_out_T_91 = 5'h1d == io_in ? 7'h3e : _io_out_T_89; // @[\\src\\main\\scala\\Functions.scala 231:46]
  assign io_out = 5'h1e == io_in ? 7'h0 : _io_out_T_91; // @[\\src\\main\\scala\\Functions.scala 231:46]
endmodule
module DisplayMultiplexer(
  input         clock,
  input         reset,
  input  [19:0] io_disp_content, // @[\\src\\main\\scala\\Functions.scala 178:14]
  output [7:0]  io_seg, // @[\\src\\main\\scala\\Functions.scala 178:14]
  output [3:0]  io_an // @[\\src\\main\\scala\\Functions.scala 178:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
`endif // RANDOMIZE_REG_INIT
  wire [4:0] decoder_io_in; // @[\\src\\main\\scala\\Functions.scala 201:23]
  wire [6:0] decoder_io_out; // @[\\src\\main\\scala\\Functions.scala 201:23]
  reg [16:0] cnt; // @[\\src\\main\\scala\\Functions.scala 185:20]
  wire  _cnt_T = cnt == 17'h1869f; // @[\\src\\main\\scala\\Functions.scala 186:18]
  wire [16:0] _cnt_T_2 = cnt + 17'h1; // @[\\src\\main\\scala\\Functions.scala 186:54]
  reg [1:0] digit; // @[\\src\\main\\scala\\Functions.scala 189:22]
  wire [1:0] _digit_T_1 = digit + 2'h1; // @[\\src\\main\\scala\\Functions.scala 190:31]
  wire  _T = 2'h0 == digit; // @[\\src\\main\\scala\\Functions.scala 194:17]
  wire  _T_1 = 2'h1 == digit; // @[\\src\\main\\scala\\Functions.scala 194:17]
  wire  _T_2 = 2'h2 == digit; // @[\\src\\main\\scala\\Functions.scala 194:17]
  wire  _T_3 = 2'h3 == digit; // @[\\src\\main\\scala\\Functions.scala 194:17]
  wire [4:0] _GEN_1 = 2'h3 == digit ? io_disp_content[19:15] : 5'h0; // @[\\src\\main\\scala\\Functions.scala 193:14 194:17 198:26]
  wire [4:0] _GEN_2 = 2'h2 == digit ? io_disp_content[14:10] : _GEN_1; // @[\\src\\main\\scala\\Functions.scala 194:17 197:26]
  wire [4:0] _GEN_3 = 2'h1 == digit ? io_disp_content[9:5] : _GEN_2; // @[\\src\\main\\scala\\Functions.scala 194:17 196:26]
  wire [3:0] _currentDot_T = 4'h0 >> digit; // @[\\src\\main\\scala\\Functions.scala 205:27]
  wire  currentDot = _currentDot_T[0]; // @[\\src\\main\\scala\\Functions.scala 205:27]
  wire [7:0] fullSeg = {currentDot,decoder_io_out}; // @[\\src\\main\\scala\\Functions.scala 206:28]
  wire [3:0] _GEN_5 = _T_3 ? 4'h8 : 4'h1; // @[\\src\\main\\scala\\Functions.scala 209:17 213:22 208:27]
  wire [3:0] _GEN_6 = _T_2 ? 4'h4 : _GEN_5; // @[\\src\\main\\scala\\Functions.scala 209:17 212:22]
  wire [3:0] _GEN_7 = _T_1 ? 4'h2 : _GEN_6; // @[\\src\\main\\scala\\Functions.scala 209:17 211:22]
  wire [3:0] select = _T ? 4'h1 : _GEN_7; // @[\\src\\main\\scala\\Functions.scala 209:17 210:22]
  SevenSegDec decoder ( // @[\\src\\main\\scala\\Functions.scala 201:23]
    .io_in(decoder_io_in),
    .io_out(decoder_io_out)
  );
  assign io_seg = ~fullSeg; // @[\\src\\main\\scala\\Functions.scala 216:13]
  assign io_an = ~select; // @[\\src\\main\\scala\\Functions.scala 217:13]
  assign decoder_io_in = 2'h0 == digit ? io_disp_content[4:0] : _GEN_3; // @[\\src\\main\\scala\\Functions.scala 194:17 195:26]
  always @(posedge clock) begin
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 185:20]
      cnt <= 17'h0; // @[\\src\\main\\scala\\Functions.scala 185:20]
    end else if (cnt == 17'h1869f) begin // @[\\src\\main\\scala\\Functions.scala 186:13]
      cnt <= 17'h0;
    end else begin
      cnt <= _cnt_T_2;
    end
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 189:22]
      digit <= 2'h0; // @[\\src\\main\\scala\\Functions.scala 189:22]
    end else if (_cnt_T) begin // @[\\src\\main\\scala\\Functions.scala 190:14]
      digit <= _digit_T_1; // @[\\src\\main\\scala\\Functions.scala 190:22]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
...
module Debouncer(
  input   clock,
  input   reset,
  input   io_btn_in, // @[\\src\\main\\scala\\Functions.scala 267:14]
  output  io_out // @[\\src\\main\\scala\\Functions.scala 267:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
  ...
  reg [31:0] _RAND_4;
`endif // RANDOMIZE_REG_INIT
  reg  btn_sync_REG; // @[\\src\\main\\scala\\Functions.scala 272:33]
  reg  btn_sync; // @[\\src\\main\\scala\\Functions.scala 272:25]
  reg  btnDebReg; // @[\\src\\main\\scala\\Functions.scala 273:26]
  reg [31:0] cntReg; // @[\\src\\main\\scala\\Functions.scala 274:23]
  wire  tick = cntReg == 32'h1869f; // @[\\src\\main\\scala\\Functions.scala 275:21]
  wire [31:0] _cntReg_T_1 = cntReg + 32'h1; // @[\\src\\main\\scala\\Functions.scala 277:20]
  reg  btnCleanPrev; // @[\\src\\main\\scala\\Functions.scala 283:29]
  assign io_out = btnDebReg & ~btnCleanPrev; // @[\\src\\main\\scala\\Functions.scala 284:23]
  always @(posedge clock) begin
    btn_sync_REG <= io_btn_in; // @[\\src\\main\\scala\\Functions.scala 272:33]
    btn_sync <= btn_sync_REG; // @[\\src\\main\\scala\\Functions.scala 272:25]
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 273:26]
      btnDebReg <= 1'h0; // @[\\src\\main\\scala\\Functions.scala 273:26]
    end else if (tick) begin // @[\\src\\main\\scala\\Functions.scala 278:15]
      btnDebReg <= btn_sync; // @[\\src\\main\\scala\\Functions.scala 280:15]
    end
    if (reset) begin // @[\\src\\main\\scala\\Functions.scala 274:23]
      cntReg <= 32'h0; // @[\\src\\main\\scala\\Functions.scala 274:23]
    end else if (tick) begin // @[\\src\\main\\scala\\Functions.scala 278:15]
      cntReg <= 32'h0; // @[\\src\\main\\scala\\Functions.scala 279:12]
    end else begin
      cntReg <= _cntReg_T_1; // @[\\src\\main\\scala\\Functions.scala 277:10]
    end
    btnCleanPrev <= btnDebReg; // @[\\src\\main\\scala\\Functions.scala 283:29]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [31:0] _current_position_fixed_point_T = rotations_io_turns; // @[\\src\\main\\scala\\SecondDriver.scala 67:69]
  wire [63:0] current_position_fixed_point = $signed(_current_position_fixed_point_T) * 32'sh222; // @[\\src\\main\\scala\\SecondDriver.scala 67:76]
  ...
  wire  _T_6 = 8'h0 == rx_io_data; // @[\\src\\main\\scala\\SecondDriver.scala 93:32]
  wire [9:0] _GEN_8 = 8'h4 == rx_io_data ? 10'hc8 : manual_speed; // @[\\src\\main\\scala\\SecondDriver.scala 72:29 93:32 98:38]
  wire [9:0] _GEN_10 = 8'h3 == rx_io_data ? 10'h12c : _GEN_8; // @[\\src\\main\\scala\\SecondDriver.scala 93:32 97:38]
  wire [9:0] _GEN_12 = 8'h2 == rx_io_data ? 10'h320 : _GEN_10; // @[\\src\\main\\scala\\SecondDriver.scala 93:32 96:38]
  wire [9:0] _GEN_14 = 8'h1 == rx_io_data ? 10'h2bc : _GEN_12; // @[\\src\\main\\scala\\SecondDriver.scala 93:32 95:38]
  wire [9:0] _GEN_17 = 8'h0 == rx_io_data ? manual_speed : _GEN_14; // @[\\src\\main\\scala\\SecondDriver.scala 72:29 93:32]
  wire  _GEN_19 = 8'h2 == CMDByte ? 1'h0 : control_mode; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 91:26 73:29]
  wire  _GEN_20 = 8'h2 == CMDByte ? _T_6 : manual_brake; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 74:29]
  wire [9:0] _GEN_21 = 8'h2 == CMDByte ? _GEN_17 : manual_speed; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 72:29]
  wire  _GEN_22 = 8'h2 == CMDByte ? 1'h0 : 8'hff == CMDByte; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 81:36]
  wire [31:0] _GEN_23 = 8'h1 == CMDByte ? $signed({{17{_target_position_cm_T_1[14]}},_target_position_cm_T_1}) :
    $signed(target_position_cm); // @[\\src\\main\\scala\\SecondDriver.scala 88:25 71:35 89:43]
  wire  _GEN_24 = 8'h1 == CMDByte | system_active; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 75:30 89:89]
  wire  _GEN_25 = 8'h1 == CMDByte ? 1'h0 : _GEN_20; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 89:113]
  wire  _GEN_26 = 8'h1 == CMDByte ? control_mode : _GEN_19; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 73:29]
  wire [9:0] _GEN_27 = 8'h1 == CMDByte ? manual_speed : _GEN_21; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 72:29]
  wire  _GEN_28 = 8'h1 == CMDByte ? 1'h0 : _GEN_22; // @[\\src\\main\\scala\\SecondDriver.scala 88:25 81:36]
  wire [31:0] _GEN_29 = 2'h2 == uartState ? $signed(_GEN_23) : $signed(target_position_cm); // @[\\src\\main\\scala\\SecondDriver.scala 84:23 71:35]
  wire  _GEN_30 = 2'h2 == uartState ? _GEN_24 : system_active; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 75:30]
  wire  _GEN_31 = 2'h2 == uartState ? _GEN_25 : manual_brake; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 74:29]
  wire  _GEN_32 = 2'h2 == uartState ? _GEN_26 : control_mode; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 73:29]
  wire [9:0] _GEN_33 = 2'h2 == uartState ? _GEN_27 : manual_speed; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 72:29]
  wire [1:0] _GEN_35 = 2'h2 == uartState ? 2'h0 : uartState; // @[\\src\\main\\scala\\SecondDriver.scala 103:19 84:23 79:26]
  wire  _GEN_41 = 2'h1 == uartState ? control_mode : _GEN_32; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 73:29]
  wire  _GEN_43 = 2'h1 == uartState ? 1'h0 : 2'h2 == uartState & _GEN_28; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 81:36]
  wire  _GEN_49 = 2'h0 == uartState ? control_mode : _GEN_41; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 73:29]
  wire  _GEN_51 = 2'h0 == uartState ? 1'h0 : _GEN_43; // @[\\src\\main\\scala\\SecondDriver.scala 84:23 81:36]
  wire  _GEN_57 = rx_io_done ? _GEN_49 : control_mode; // @[\\src\\main\\scala\\SecondDriver.scala 83:21 73:29]
  wire  reset_triggered = rx_io_done & _GEN_51; // @[\\src\\main\\scala\\SecondDriver.scala 83:21 81:36]
  wire [31:0] _at_position_T_2 = $signed(target_position_cm) - 32'sh1; // @[\\src\\main\\scala\\SecondDriver.scala 110:80]
  wire [51:0] _GEN_91 = {{20{_at_position_T_2[31]}},_at_position_T_2}; // @[\\src\\main\\scala\\SecondDriver.scala 110:58]
  wire [31:0] _at_position_T_6 = $signed(target_position_cm) + 32'sh1; // @[\\src\\main\\scala\\SecondDriver.scala 110:131]
  wire [51:0] _GEN_92 = {{20{_at_position_T_6[31]}},_at_position_T_6}; // @[\\src\\main\\scala\\SecondDriver.scala 110:109]
  wire  at_position = control_mode & ($signed(current_position_cm) >= $signed(_GEN_91) & $signed(current_position_cm)
     <= $signed(_GEN_92)); // @[\\src\\main\\scala\\SecondDriver.scala 110:34]
  wire  _pid_io_resetBuffer_T_2 = ~system_active; // @[\\src\\main\\scala\\SecondDriver.scala 114:58]
  wire [31:0] _pid_duty_raw_T_2 = $signed(pid_io_controlOut) + 32'sh800; // @[\\src\\main\\scala\\SecondDriver.scala 120:42]
  wire [54:0] _pid_duty_raw_T_3 = $signed(_pid_duty_raw_T_2) * 23'sh3ff000; // @[\\src\\main\\scala\\SecondDriver.scala 120:61]
  wire [42:0] pid_duty_raw = _pid_duty_raw_T_3[54:12]; // @[\\src\\main\\scala\\SecondDriver.scala 120:90]
  wire [9:0] _pid_duty_T_2 = pid_duty_raw > 43'h3ff ? 10'h3ff : pid_duty_raw[9:0]; // @[\\src\\main\\scala\\SecondDriver.scala 121:45]
  wire [9:0] pid_duty = at_position ? 10'h200 : _pid_duty_T_2; // @[\\src\\main\\scala\\SecondDriver.scala 121:21]
  ...
  wire  _T_15 = ~tx_io_busy; // @[\\src\\main\\scala\\SecondDriver.scala 149:14]
  wire [7:0] _GEN_64 = ~tx_io_busy ? 8'hff : 8'h0; // @[\\src\\main\\scala\\SecondDriver.scala 144:14 149:27 150:22]
  wire [7:0] _GEN_67 = _T_15 ? current_position_cm[15:8] : 8'h0; // @[\\src\\main\\scala\\SecondDriver.scala 144:14 155:27 156:22]
  wire [1:0] _GEN_69 = _T_15 ? 2'h2 : txState; // @[\\src\\main\\scala\\SecondDriver.scala 155:27 158:19 143:24]
  wire [23:0] _GEN_70 = _T_15 ? 24'h0 : txTimer; // @[\\src\\main\\scala\\SecondDriver.scala 155:27 159:19 141:24]
  wire [7:0] _GEN_71 = _T_15 ? current_position_cm[7:0] : 8'h0; // @[\\src\\main\\scala\\SecondDriver.scala 144:14 162:27 163:22]
  wire [1:0] _GEN_73 = _T_15 ? 2'h0 : txState; // @[\\src\\main\\scala\\SecondDriver.scala 162:27 165:19 143:24]
  wire [7:0] _GEN_75 = 2'h2 == txState ? _GEN_71 : 8'h0; // @[\\src\\main\\scala\\SecondDriver.scala 144:14 147:21]
  wire  _GEN_76 = 2'h2 == txState & _T_15; // @[\\src\\main\\scala\\SecondDriver.scala 145:15 147:21]
  wire [1:0] _GEN_77 = 2'h2 == txState ? _GEN_73 : txState; // @[\\src\\main\\scala\\SecondDriver.scala 147:21 143:24]
  wire [23:0] _GEN_78 = 2'h2 == txState ? _GEN_70 : txTimer; // @[\\src\\main\\scala\\SecondDriver.scala 147:21 141:24]
  wire [7:0] _GEN_79 = 2'h1 == txState ? _GEN_67 : _GEN_75; // @[\\src\\main\\scala\\SecondDriver.scala 147:21]
  wire  _GEN_80 = 2'h1 == txState ? _T_15 : _GEN_76; // @[\\src\\main\\scala\\SecondDriver.scala 147:21]
  wire [7:0] _GEN_83 = 2'h0 == txState ? _GEN_64 : _GEN_79; // @[\\src\\main\\scala\\SecondDriver.scala 147:21]
  wire  _GEN_84 = 2'h0 == txState ? _T_15 : _GEN_80; // @[\\src\\main\\scala\\SecondDriver.scala 147:21]
  ...
  assign tx_io_data = txTimer >= 24'h2625a0 ? _GEN_83 : 8'h0; // @[\\src\\main\\scala\\SecondDriver.scala 144:14 146:30]
  assign tx_io_start = txTimer >= 24'h2625a0 & _GEN_84; // @[\\src\\main\\scala\\SecondDriver.scala 145:15 146:30]
  ...
  assign pid_io_setPoint = target_position_cm; // @[\\src\\main\\scala\\SecondDriver.scala 112:53]
  assign pid_io_measuredVal = current_position_fixed_point[31:0]; // @[\\src\\main\\scala\\SecondDriver.scala 111:22]
  assign pid_io_resetBuffer = ~control_mode | manual_brake | ~system_active | at_position; // @[\\src\\main\\scala\\SecondDriver.scala 114:73]
  ...
  assign stuck_detector_io_clear_shutdown = error_clear_debounce_io_out | reset_triggered; // @[\\src\\main\\scala\\SecondDriver.scala 107:68]
  ...
  always @(posedge clock) begin
    ...
    end else if (io_photo_sensor_A == rotations_io_signal_A_out) begin // @[\\src\\main\\scala\\SecondDriver.scala 43:24]
    ...
    if (reset) begin // @[\\src\\main\\scala\\SecondDriver.scala 42:23]
      ...
      if (rotations_io_signal_A_cnt == 14'h64) begin // @[\\src\\main\\scala\\SecondDriver.scala 44:56]
        rotations_io_signal_A_out <= io_photo_sensor_A; // @[\\src\\main\\scala\\SecondDriver.scala 44:62]
      end
    end
    if (reset) begin // @[\\src\\main\\scala\\SecondDriver.scala 41:23]
      rotations_io_signal_B_cnt <= 14'h0; // @[\\src\\main\\scala\\SecondDriver.scala 41:23]
    end else if (io_photo_sensor_B == rotations_io_signal_B_out) begin // @[\\src\\main\\scala\\SecondDriver.scala 43:24]
    ...
    if (reset) begin // @[\\src\\main\\scala\\SecondDriver.scala 42:23]
      ...
      if (rotations_io_signal_B_cnt == 14'h64) begin // @[\\src\\main\\scala\\SecondDriver.scala 44:56]
        rotations_io_signal_B_out <= io_photo_sensor_B; // @[\\src\\main\\scala\\SecondDriver.scala 44:62]
      end
    end
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_4 = {1{`RANDOM}};
  target_position_cm = _RAND_4[31:0];
  _RAND_5 = {1{`RANDOM}};
  ...
  _RAND_9 = {1{`RANDOM}};
  uartState = _RAND_9[1:0];
  _RAND_10 = {1{`RANDOM}};
  CMDByte = _RAND_10[7:0];
  _RAND_11 = {1{`RANDOM}};
  txTimer = _RAND_11[23:0];
  _RAND_12 = {1{`RANDOM}};
  txState = _RAND_12[1:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL
