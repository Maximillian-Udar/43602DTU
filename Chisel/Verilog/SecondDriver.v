...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [63:0] _pTerm_s1_T = 32'sh50000 * $signed(error); // @[src/main/scala/Functions.scala 296:34]
  ...
  wire [63:0] _dTerm_s2_T = 32'sh7d0000 * $signed(dDiff_s1); // @[src/main/scala/Functions.scala 302:35]
