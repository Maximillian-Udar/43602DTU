...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [11:0] _T_1 = 12'hfa0 - 12'h1; // @[src/main/scala/Functions.scala 37:35]
  ...
  wire [21:0] _threshold_T = io_duty_cycle * 12'hfa0; // @[src/main/scala/Functions.scala 43:34]
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [19:0] ramp_timer; // @[src/main/scala/SecondDriver.scala 60:35]
  wire  ramp_tick = ramp_timer == 20'hc34ff; // @[src/main/scala/SecondDriver.scala 61:39]
  ...
  wire [19:0] _ramp_timer_T_1 = ramp_timer + 20'h1; // @[src/main/scala/SecondDriver.scala 70:42]
  ...
  wire [9:0] _GEN_15 = 8'h4 == rx_io_data ? 10'h1c0 : manual_speed; // @[src/main/scala/SecondDriver.scala 114:32 119:38 56:35]
  wire [9:0] _GEN_17 = 8'h3 == rx_io_data ? 10'h1db : _GEN_15; // @[src/main/scala/SecondDriver.scala 114:32 118:38]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[src/main/scala/SecondDriver.scala 60:35]
      ramp_timer <= 20'h0; // @[src/main/scala/SecondDriver.scala 60:35]
    end else if (ramp_tick) begin // @[src/main/scala/SecondDriver.scala 63:19]
      ramp_timer <= 20'h0; // @[src/main/scala/SecondDriver.scala 64:16]
    end else begin
