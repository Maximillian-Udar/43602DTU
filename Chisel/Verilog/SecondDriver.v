...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [12:0] _T_1 = 13'h10fb - 13'h1; // @[src/main/scala/Functions.scala 37:35]
  ...
  wire [22:0] _threshold_T = io_duty_cycle * 13'h10fb; // @[src/main/scala/Functions.scala 43:34]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [63:0] _pTerm_s1_T = 32'sh4cd * $signed(error); // @[src/main/scala/Functions.scala 294:34]
  ...
  wire [63:0] _rawOutput_s3_T_2 = $signed(pTerm_s2) + $signed(iClamped_s3); // @[src/main/scala/Functions.scala 304:31]
  wire [63:0] rawOutput_s3 = $signed(_rawOutput_s3_T_2) + $signed(dTerm_s2); // @[src/main/scala/Functions.scala 304:45]
  reg  tick_s4; // @[src/main/scala/Functions.scala 306:24]
  reg [63:0] sum_s3; // @[src/main/scala/Functions.scala 307:25]
  wire [63:0] _outputReg_T_2 = $signed(sum_s3) < -64'sh800000 ? $signed(-64'sh800000) : $signed(sum_s3); // @[src/main/scala/Functions.scala 317:59]
  wire [63:0] _outputReg_T_3 = $signed(sum_s3) > 64'sh800000 ? $signed(64'sh800000) : $signed(_outputReg_T_2); // @[src/main/scala/Functions.scala 317:24]
  wire [43:0] _GEN_17 = {$signed(outputReg), 12'h0}; // @[src/main/scala/Functions.scala 316:24 317:18 285:29]
  wire [63:0] _GEN_8 = tick_s4 ? $signed(_outputReg_T_3) : $signed({{20{_GEN_17[43]}},_GEN_17}); // @[src/main/scala/Functions.scala 316:24 317:18 285:29]
  wire [63:0] _GEN_9 = tick_s3 ? $signed(iClamped_s3) : $signed({{20{_GEN_15[43]}},_GEN_15}); // @[src/main/scala/Functions.scala 313:24 314:18 283:29]
  wire [63:0] _GEN_11 = tick_s3 ? $signed({{20{_GEN_17[43]}},_GEN_17}) : $signed(_GEN_8); // @[src/main/scala/Functions.scala 313:24 285:29]
  wire [63:0] _GEN_12 = io_resetBuffer ? $signed(64'sh0) : $signed(_GEN_9); // @[src/main/scala/Functions.scala 309:24 310:18]
  wire [63:0] _GEN_14 = io_resetBuffer ? $signed(64'sh0) : $signed(_GEN_11); // @[src/main/scala/Functions.scala 309:24 312:18]
  ...
  assign io_controlOut = outputReg; // @[src/main/scala/Functions.scala 319:17]
  always @(posedge clock) begin
    ...
    end else if (io_resetBuffer) begin // @[src/main/scala/Functions.scala 309:24]
      prevErrorReg <= 32'sh0; // @[src/main/scala/Functions.scala 311:18]
    end else if (tick_s3) begin // @[src/main/scala/Functions.scala 313:24]
      prevErrorReg <= error_s2; // @[src/main/scala/Functions.scala 315:18]
    end
    ...
    tick_s4 <= tick_s3; // @[src/main/scala/Functions.scala 306:24]
    if (tick_s3) begin // @[src/main/scala/Functions.scala 307:25]
      sum_s3 <= rawOutput_s3; // @[src/main/scala/Functions.scala 307:25]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [19:0] ramp_timer; // @[src/main/scala/SecondDriver.scala 59:27]
  wire  ramp_tick = ramp_timer == 20'hc34ff; // @[src/main/scala/SecondDriver.scala 60:30]
  wire [9:0] _manual_ramped_T_1 = manual_ramped + 10'h1; // @[src/main/scala/SecondDriver.scala 65:38]
  wire [9:0] _manual_ramped_T_3 = manual_ramped - 10'h1; // @[src/main/scala/SecondDriver.scala 67:38]
  wire [19:0] _ramp_timer_T_1 = ramp_timer + 20'h1; // @[src/main/scala/SecondDriver.scala 68:49]
  reg [31:0] target_position_cm; // @[src/main/scala/SecondDriver.scala 71:35]
  reg  control_mode; // @[src/main/scala/SecondDriver.scala 72:29]
  reg  manual_brake; // @[src/main/scala/SecondDriver.scala 73:29]
  reg  system_active; // @[src/main/scala/SecondDriver.scala 74:30]
  reg [31:0] initial_offset; // @[src/main/scala/SecondDriver.scala 75:31]
  wire [31:0] current_turns = $signed(rotations_io_turns) - $signed(initial_offset); // @[src/main/scala/SecondDriver.scala 77:42]
  wire [63:0] full_pos_calc = $signed(current_turns) * 32'sh222; // @[src/main/scala/SecondDriver.scala 80:56]
  reg [31:0] current_position_fixed_point; // @[src/main/scala/SecondDriver.scala 81:45]
  wire [19:0] _current_position_cm_T = current_position_fixed_point[31:12]; // @[src/main/scala/SecondDriver.scala 82:78]
  wire [19:0] current_position_cm = system_active ? $signed(_current_position_cm_T) : $signed(20'sh0); // @[src/main/scala/SecondDriver.scala 82:32]
  reg [1:0] uartState; // @[src/main/scala/SecondDriver.scala 85:26]
  reg [7:0] CMDByte; // @[src/main/scala/SecondDriver.scala 86:24]
  reg  target_updated; // @[src/main/scala/SecondDriver.scala 89:31]
  wire  _GEN_11 = pid_tick ? 1'h0 : target_updated; // @[src/main/scala/SecondDriver.scala 90:18 89:31 90:35]
  wire  _T_7 = ~system_active; // @[src/main/scala/SecondDriver.scala 100:18]
  wire [31:0] _GEN_13 = ~system_active ? $signed(rotations_io_turns) : $signed(initial_offset); // @[src/main/scala/SecondDriver.scala 100:{34,51} 75:31]
  wire [7:0] _target_position_cm_T = rx_io_data; // @[src/main/scala/SecondDriver.scala 101:48]
  wire  _T_10 = 8'h0 == rx_io_data; // @[src/main/scala/SecondDriver.scala 112:32]
  wire [9:0] _GEN_15 = 8'h4 == rx_io_data ? 10'h1c0 : manual_speed; // @[src/main/scala/SecondDriver.scala 112:32 117:38 55:30]
  wire [9:0] _GEN_17 = 8'h3 == rx_io_data ? 10'h1db : _GEN_15; // @[src/main/scala/SecondDriver.scala 112:32 116:38]
  wire [9:0] _GEN_19 = 8'h2 == rx_io_data ? 10'h2da : _GEN_17; // @[src/main/scala/SecondDriver.scala 112:32 115:38]
  wire [9:0] _GEN_21 = 8'h1 == rx_io_data ? 10'h2bc : _GEN_19; // @[src/main/scala/SecondDriver.scala 112:32 114:38]
  wire [9:0] _GEN_24 = 8'h0 == rx_io_data ? 10'h200 : _GEN_21; // @[src/main/scala/SecondDriver.scala 112:32 113:62]
  wire [31:0] _GEN_26 = 8'h2 == CMDByte ? $signed(_GEN_13) : $signed(initial_offset); // @[src/main/scala/SecondDriver.scala 98:25 75:31]
  wire  _GEN_27 = 8'h2 == CMDByte | system_active; // @[src/main/scala/SecondDriver.scala 98:25 109:27 74:30]
  wire  _GEN_28 = 8'h2 == CMDByte ? 1'h0 : control_mode; // @[src/main/scala/SecondDriver.scala 98:25 110:26 72:29]
  wire  _GEN_29 = 8'h2 == CMDByte ? _T_10 : manual_brake; // @[src/main/scala/SecondDriver.scala 98:25 73:29]
  wire [9:0] _GEN_30 = 8'h2 == CMDByte ? _GEN_24 : manual_speed; // @[src/main/scala/SecondDriver.scala 98:25 55:30]
  wire  _GEN_31 = 8'h2 == CMDByte ? 1'h0 : 8'hff == CMDByte; // @[src/main/scala/SecondDriver.scala 98:25 87:36]
  wire [31:0] _GEN_32 = 8'h1 == CMDByte ? $signed(_GEN_13) : $signed(_GEN_26); // @[src/main/scala/SecondDriver.scala 98:25]
  wire [31:0] _GEN_33 = 8'h1 == CMDByte ? $signed({{24{_target_position_cm_T[7]}},_target_position_cm_T}) : $signed(
    target_position_cm); // @[src/main/scala/SecondDriver.scala 98:25 101:32 71:35]
  wire  _GEN_34 = 8'h1 == CMDByte | _GEN_27; // @[src/main/scala/SecondDriver.scala 98:25 102:27]
  wire  _GEN_35 = 8'h1 == CMDByte | _GEN_28; // @[src/main/scala/SecondDriver.scala 98:25 103:26]
  wire  _GEN_36 = 8'h1 == CMDByte ? 1'h0 : _GEN_29; // @[src/main/scala/SecondDriver.scala 98:25 104:26]
  wire  _GEN_37 = 8'h1 == CMDByte | _GEN_11; // @[src/main/scala/SecondDriver.scala 98:25 105:28]
  wire [9:0] _GEN_38 = 8'h1 == CMDByte ? manual_speed : _GEN_30; // @[src/main/scala/SecondDriver.scala 98:25 55:30]
  wire  _GEN_39 = 8'h1 == CMDByte ? 1'h0 : _GEN_31; // @[src/main/scala/SecondDriver.scala 98:25 87:36]
  wire [31:0] _GEN_40 = 2'h2 == uartState ? $signed(_GEN_32) : $signed(initial_offset); // @[src/main/scala/SecondDriver.scala 94:23 75:31]
  wire [31:0] _GEN_41 = 2'h2 == uartState ? $signed(_GEN_33) : $signed(target_position_cm); // @[src/main/scala/SecondDriver.scala 94:23 71:35]
  wire  _GEN_42 = 2'h2 == uartState ? _GEN_34 : system_active; // @[src/main/scala/SecondDriver.scala 94:23 74:30]
  wire  _GEN_43 = 2'h2 == uartState ? _GEN_35 : control_mode; // @[src/main/scala/SecondDriver.scala 94:23 72:29]
  wire  _GEN_44 = 2'h2 == uartState ? _GEN_36 : manual_brake; // @[src/main/scala/SecondDriver.scala 94:23 73:29]
  wire  _GEN_45 = 2'h2 == uartState ? _GEN_37 : _GEN_11; // @[src/main/scala/SecondDriver.scala 94:23]
  wire [9:0] _GEN_46 = 2'h2 == uartState ? _GEN_38 : manual_speed; // @[src/main/scala/SecondDriver.scala 94:23 55:30]
  wire [1:0] _GEN_48 = 2'h2 == uartState ? 2'h0 : uartState; // @[src/main/scala/SecondDriver.scala 122:19 94:23 85:26]
  wire  _GEN_54 = 2'h1 == uartState ? control_mode : _GEN_43; // @[src/main/scala/SecondDriver.scala 94:23 72:29]
  wire  _GEN_58 = 2'h1 == uartState ? 1'h0 : 2'h2 == uartState & _GEN_39; // @[src/main/scala/SecondDriver.scala 94:23 87:36]
  wire  _GEN_64 = 2'h0 == uartState ? control_mode : _GEN_54; // @[src/main/scala/SecondDriver.scala 94:23 72:29]
  wire  _GEN_68 = 2'h0 == uartState ? 1'h0 : _GEN_58; // @[src/main/scala/SecondDriver.scala 94:23 87:36]
  wire  _GEN_74 = rx_io_done ? _GEN_64 : control_mode; // @[src/main/scala/SecondDriver.scala 93:21 72:29]
  wire  reset_triggered = rx_io_done & _GEN_68; // @[src/main/scala/SecondDriver.scala 93:21 87:36]
  wire [36:0] _target_turns_T = $signed(target_position_cm) * 5'shf; // @[src/main/scala/SecondDriver.scala 129:50]
  reg [37:0] target_turns; // @[src/main/scala/SecondDriver.scala 129:29]
  wire [37:0] _at_position_T_2 = $signed(target_turns) - 38'sh3; // @[src/main/scala/SecondDriver.scala 131:87]
  wire [37:0] _GEN_110 = {{6{current_turns[31]}},current_turns}; // @[src/main/scala/SecondDriver.scala 131:71]
  wire [37:0] _at_position_T_6 = $signed(target_turns) + 38'sh3; // @[src/main/scala/SecondDriver.scala 131:132]
  wire  _at_position_T_9 = system_active ? $signed(_GEN_110) >= $signed(_at_position_T_2) & $signed(_GEN_110) <=
    $signed(_at_position_T_6) : 1'h1; // @[src/main/scala/SecondDriver.scala 131:40]
  wire  at_position = control_mode & _at_position_T_9; // @[src/main/scala/SecondDriver.scala 131:34]
  wire [31:0] raw_pid_out = pid_io_controlOut; // @[src/main/scala/SecondDriver.scala 142:39]
  wire [26:0] _pid_offset_T_1 = raw_pid_out[31:5]; // @[src/main/scala/SecondDriver.scala 147:64]
  wire [26:0] _pid_offset_T_4 = $signed(_pid_offset_T_1) + 27'sh73; // @[src/main/scala/SecondDriver.scala 147:70]
  wire [23:0] _pid_offset_T_5 = raw_pid_out[31:8]; // @[src/main/scala/SecondDriver.scala 147:92]
  wire [23:0] _pid_offset_T_8 = $signed(_pid_offset_T_5) - 24'sh19; // @[src/main/scala/SecondDriver.scala 147:98]
  reg [26:0] pid_offset; // @[src/main/scala/SecondDriver.scala 147:27]
  wire [26:0] pid_duty_raw = 27'sh200 + $signed(pid_offset); // @[src/main/scala/SecondDriver.scala 149:28]
  wire [26:0] _pid_duty_T_2 = 27'sh200 + $signed(pid_offset); // @[src/main/scala/SecondDriver.scala 150:119]
  wire [26:0] _pid_duty_T_3 = $signed(pid_duty_raw) < 27'sh0 ? 27'h0 : _pid_duty_T_2; // @[src/main/scala/SecondDriver.scala 150:80]
  wire [26:0] _pid_duty_T_4 = $signed(pid_duty_raw) > 27'sh3ff ? 27'h3ff : _pid_duty_T_3; // @[src/main/scala/SecondDriver.scala 150:45]
  wire [26:0] pid_duty = at_position ? 27'h200 : _pid_duty_T_4; // @[src/main/scala/SecondDriver.scala 150:21]
  wire [26:0] active_duty = control_mode ? pid_duty : {{17'd0}, manual_ramped}; // @[src/main/scala/SecondDriver.scala 152:24]
  wire  is_moving_back = active_duty < 27'h200; // @[src/main/scala/SecondDriver.scala 153:36]
  wire  is_moving_fwd = active_duty > 27'h200; // @[src/main/scala/SecondDriver.scala 154:35]
  wire  _block_neg_T_3 = ~at_position; // @[src/main/scala/SecondDriver.scala 156:96]
  wire  block_neg = system_active & $signed(current_position_cm) <= 20'sh0 & is_moving_back & ~at_position; // @[src/main/scala/SecondDriver.scala 156:93]
  wire  block_pos = $signed(current_position_cm) >= 20'sh5a & is_moving_fwd & _block_neg_T_3; // @[src/main/scala/SecondDriver.scala 157:66]
  reg [26:0] pwm_signal_io_duty_cycle_REG; // @[src/main/scala/SecondDriver.scala 159:38]
  wire  motor_stopped = manual_brake | stuck_detector_io_motor_disable | _T_7 | at_position | block_neg | block_pos; // @[src/main/scala/SecondDriver.scala 160:117]
  reg [23:0] txTimer; // @[src/main/scala/SecondDriver.scala 170:24]
  reg [1:0] txState; // @[src/main/scala/SecondDriver.scala 172:24]
  wire  _T_19 = ~tx_io_busy; // @[src/main/scala/SecondDriver.scala 176:24]
  wire [7:0] _GEN_83 = ~tx_io_busy ? 8'hff : 8'h0; // @[src/main/scala/SecondDriver.scala 173:14 176:{37,50}]
  wire [7:0] _GEN_86 = _T_19 ? current_position_cm[15:8] : 8'h0; // @[src/main/scala/SecondDriver.scala 173:14 177:{37,50}]
  wire [1:0] _GEN_88 = _T_19 ? 2'h2 : txState; // @[src/main/scala/SecondDriver.scala 177:119 172:24 177:37]
  wire [23:0] _GEN_89 = _T_19 ? 24'h0 : txTimer; // @[src/main/scala/SecondDriver.scala 177:136 170:24 177:37]
  wire [7:0] _GEN_90 = _T_19 ? current_position_cm[7:0] : 8'h0; // @[src/main/scala/SecondDriver.scala 173:14 178:{36,49}]
  wire [1:0] _GEN_92 = _T_19 ? 2'h0 : txState; // @[src/main/scala/SecondDriver.scala 178:117 172:24 178:36]
  wire [7:0] _GEN_94 = 2'h2 == txState ? _GEN_90 : 8'h0; // @[src/main/scala/SecondDriver.scala 173:14 175:21]
  wire  _GEN_95 = 2'h2 == txState & _T_19; // @[src/main/scala/SecondDriver.scala 175:21 173:34]
  wire [1:0] _GEN_96 = 2'h2 == txState ? _GEN_92 : txState; // @[src/main/scala/SecondDriver.scala 175:21 172:24]
  wire [23:0] _GEN_97 = 2'h2 == txState ? _GEN_89 : txTimer; // @[src/main/scala/SecondDriver.scala 175:21 170:24]
  wire [7:0] _GEN_98 = 2'h1 == txState ? _GEN_86 : _GEN_94; // @[src/main/scala/SecondDriver.scala 175:21]
  wire  _GEN_99 = 2'h1 == txState ? _T_19 : _GEN_95; // @[src/main/scala/SecondDriver.scala 175:21]
  wire [7:0] _GEN_102 = 2'h0 == txState ? _GEN_83 : _GEN_98; // @[src/main/scala/SecondDriver.scala 175:21]
  wire  _GEN_103 = 2'h0 == txState ? _T_19 : _GEN_99; // @[src/main/scala/SecondDriver.scala 175:21]
  wire [23:0] _txTimer_T_1 = txTimer + 24'h1; // @[src/main/scala/SecondDriver.scala 180:36]
  wire [43:0] _GEN_112 = {$signed(target_position_cm), 12'h0}; // @[src/main/scala/SecondDriver.scala 134:19]
  ...
  assign io_uart_tx = tx_io_tx; // @[src/main/scala/SecondDriver.scala 181:14]
  assign io_T1 = _T_7 ? 1'h0 : pwm_signal_io_T1; // @[src/main/scala/SecondDriver.scala 163:25 164:11 166:11]
  assign io_T2 = _T_7 | pwm_signal_io_T2; // @[src/main/scala/SecondDriver.scala 163:25 164:29 166:38]
  assign io_T3 = _T_7 ? 1'h0 : pwm_signal_io_T3; // @[src/main/scala/SecondDriver.scala 163:25 164:46 166:65]
  assign io_T4 = _T_7 | pwm_signal_io_T4; // @[src/main/scala/SecondDriver.scala 163:25 164:64 166:92]
  assign io_seg = display_io_seg; // @[src/main/scala/SecondDriver.scala 184:34]
  assign io_an = display_io_an; // @[src/main/scala/SecondDriver.scala 184:9]
  assign rx_clock = clock;
  assign rx_reset = reset;
  assign rx_io_rx = io_uart_rx; // @[src/main/scala/SecondDriver.scala 43:12]
  assign tx_clock = clock;
  assign tx_reset = reset;
  assign tx_io_data = txTimer >= 24'h2625a0 ? _GEN_102 : 8'h0; // @[src/main/scala/SecondDriver.scala 173:14 174:30]
  assign tx_io_start = txTimer >= 24'h2625a0 & _GEN_103; // @[src/main/scala/SecondDriver.scala 174:30 173:34]
  assign pwm_signal_clock = clock;
  assign pwm_signal_reset = reset;
  assign pwm_signal_io_duty_cycle = pwm_signal_io_duty_cycle_REG[9:0]; // @[src/main/scala/SecondDriver.scala 159:28]
  assign pwm_signal_io_brake = manual_brake | stuck_detector_io_motor_disable | _T_7 | at_position | block_neg |
    block_pos; // @[src/main/scala/SecondDriver.scala 160:117]
  assign pid_clock = clock;
  assign pid_reset = reset;
  assign pid_io_setPoint = _GEN_112[31:0]; // @[src/main/scala/SecondDriver.scala 134:19]
  assign pid_io_measuredVal = current_position_fixed_point; // @[src/main/scala/SecondDriver.scala 133:22]
  assign pid_io_tick = pid_timer == 17'h1869f; // @[src/main/scala/SecondDriver.scala 51:29]
  assign pid_io_resetBuffer = ~control_mode | manual_brake | _T_7 | at_position | target_updated; // @[src/main/scala/SecondDriver.scala 136:88]
  ...
  assign stuck_detector_io_clear_shutdown = error_clear_debounce_io_out | reset_triggered; // @[src/main/scala/SecondDriver.scala 126:68]
  assign display_clock = clock;
  assign display_reset = reset;
  assign display_io_disp_content = motor_stopped ? 20'hdf2f8 : 20'h57797; // @[src/main/scala/SecondDriver.scala 188:33]
  ...
  always @(posedge clock) begin
    ...
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (!(2'h0 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
        if (!(2'h1 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
    ...
    end else if (ramp_tick) begin // @[src/main/scala/SecondDriver.scala 62:19]
      if (manual_ramped < manual_speed) begin // @[src/main/scala/SecondDriver.scala 64:40]
        manual_ramped <= _manual_ramped_T_1; // @[src/main/scala/SecondDriver.scala 65:21]
      end else if (manual_ramped > manual_speed) begin // @[src/main/scala/SecondDriver.scala 66:46]
        manual_ramped <= _manual_ramped_T_3; // @[src/main/scala/SecondDriver.scala 67:21]
      end
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 59:27]
      ramp_timer <= 20'h0; // @[src/main/scala/SecondDriver.scala 59:27]
    end else if (ramp_tick) begin // @[src/main/scala/SecondDriver.scala 62:19]
      ramp_timer <= 20'h0; // @[src/main/scala/SecondDriver.scala 63:16]
    end else begin
      ramp_timer <= _ramp_timer_T_1; // @[src/main/scala/SecondDriver.scala 68:35]
    end
    ...
    control_mode <= reset | _GEN_74; // @[src/main/scala/SecondDriver.scala 72:{29,29}]
    if (reset) begin // @[src/main/scala/SecondDriver.scala 73:29]
      manual_brake <= 1'h0; // @[src/main/scala/SecondDriver.scala 73:29]
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (!(2'h0 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
        if (!(2'h1 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
    ...
    if (reset) begin // @[src/main/scala/SecondDriver.scala 74:30]
      system_active <= 1'h0; // @[src/main/scala/SecondDriver.scala 74:30]
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (!(2'h0 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
        if (!(2'h1 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
    ...
    if (reset) begin // @[src/main/scala/SecondDriver.scala 75:31]
      initial_offset <= 32'sh0; // @[src/main/scala/SecondDriver.scala 75:31]
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (!(2'h0 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
        if (!(2'h1 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
    ...
    current_position_fixed_point <= full_pos_calc[31:0]; // @[src/main/scala/SecondDriver.scala 81:79]
    if (reset) begin // @[src/main/scala/SecondDriver.scala 85:26]
      uartState <= 2'h0; // @[src/main/scala/SecondDriver.scala 85:26]
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (2'h0 == uartState) begin // @[src/main/scala/SecondDriver.scala 94:23]
        if (rx_io_data == 8'haa) begin // @[src/main/scala/SecondDriver.scala 95:49]
          uartState <= 2'h1; // @[src/main/scala/SecondDriver.scala 95:61]
        end
      end else if (2'h1 == uartState) begin // @[src/main/scala/SecondDriver.scala 94:23]
        uartState <= 2'h2; // @[src/main/scala/SecondDriver.scala 96:51]
      end else begin
        uartState <= _GEN_48;
      end
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 86:24]
      CMDByte <= 8'h0; // @[src/main/scala/SecondDriver.scala 86:24]
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (!(2'h0 == uartState)) begin // @[src/main/scala/SecondDriver.scala 94:23]
        if (2'h1 == uartState) begin // @[src/main/scala/SecondDriver.scala 94:23]
          CMDByte <= rx_io_data; // @[src/main/scala/SecondDriver.scala 96:26]
        end
      end
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 89:31]
      target_updated <= 1'h0; // @[src/main/scala/SecondDriver.scala 89:31]
    end else if (rx_io_done) begin // @[src/main/scala/SecondDriver.scala 93:21]
      if (2'h0 == uartState) begin // @[src/main/scala/SecondDriver.scala 94:23]
    ...
    target_turns <= $signed(_target_turns_T) / 3'sh2; // @[src/main/scala/SecondDriver.scala 129:58]
    if ($signed(raw_pid_out) > 32'sh0) begin // @[src/main/scala/SecondDriver.scala 147:31]
      pid_offset <= _pid_offset_T_4;
    end else begin
      pid_offset <= {{3{_pid_offset_T_8[23]}},_pid_offset_T_8};
    end
    if (block_neg | block_pos) begin // @[src/main/scala/SecondDriver.scala 159:42]
      pwm_signal_io_duty_cycle_REG <= 27'h200;
    end else if (control_mode) begin // @[src/main/scala/SecondDriver.scala 152:24]
      if (at_position) begin // @[src/main/scala/SecondDriver.scala 150:21]
        pwm_signal_io_duty_cycle_REG <= 27'h200;
      end else if ($signed(pid_duty_raw) > 27'sh3ff) begin // @[src/main/scala/SecondDriver.scala 150:45]
    ...
    if (reset) begin // @[src/main/scala/SecondDriver.scala 170:24]
      txTimer <= 24'h0; // @[src/main/scala/SecondDriver.scala 170:24]
    end else if (txTimer >= 24'h2625a0) begin // @[src/main/scala/SecondDriver.scala 174:30]
      if (!(2'h0 == txState)) begin // @[src/main/scala/SecondDriver.scala 175:21]
        if (2'h1 == txState) begin // @[src/main/scala/SecondDriver.scala 175:21]
          txTimer <= _GEN_89;
        end else begin
          txTimer <= _GEN_97;
        end
      ...
      txTimer <= _txTimer_T_1; // @[src/main/scala/SecondDriver.scala 180:25]
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 172:24]
      txState <= 2'h0; // @[src/main/scala/SecondDriver.scala 172:24]
    end else if (txTimer >= 24'h2625a0) begin // @[src/main/scala/SecondDriver.scala 174:30]
      if (2'h0 == txState) begin // @[src/main/scala/SecondDriver.scala 175:21]
        if (~tx_io_busy) begin // @[src/main/scala/SecondDriver.scala 176:37]
          txState <= 2'h1; // @[src/main/scala/SecondDriver.scala 176:92]
        end
      end else if (2'h1 == txState) begin // @[src/main/scala/SecondDriver.scala 175:21]
        txState <= _GEN_88;
      end else begin
        txState <= _GEN_96;
      end
