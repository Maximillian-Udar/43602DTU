...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [11:0] _T_1 = 12'hfa0 - 12'h1; // @[src/main/scala/Functions.scala 49:35]
  wire [31:0] _GEN_5 = {{20'd0}, _T_1}; // @[src/main/scala/Functions.scala 49:19]
  wire [31:0] _pwmCounter_T_1 = pwmCounter + 32'h1; // @[src/main/scala/Functions.scala 52:30]
  wire [21:0] _threshold_T = io_duty_cycle * 12'hfa0; // @[src/main/scala/Functions.scala 55:34]
  wire [11:0] threshold = _threshold_T[21:10]; // @[src/main/scala/Functions.scala 55:50]
  wire [31:0] _GEN_6 = {{20'd0}, threshold}; // @[src/main/scala/Functions.scala 56:30]
...
`endif // RANDOMIZE_REG_INIT
  ...
  always @(posedge clock) begin
    ...
    pTerm <= 32'sh50000 * $signed(errorReg); // @[src/main/scala/Functions.scala 93:29]
    integralReg <= _GEN_7[31:0]; // @[src/main/scala/Functions.scala 94:{28,28}]
    iTermNext <= 32'sh5000 * $signed(errorReg); // @[src/main/scala/Functions.scala 95:33]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [9:0] _GEN_2 = 8'h4 == rx_io_data ? 10'h46 : manual_speed; // @[src/main/scala/MotorDriver.scala 39:34 68:44 73:52]
  wire  _GEN_3 = 8'h4 == rx_io_data ? 1'h0 : 8'h5 == rx_io_data; // @[src/main/scala/MotorDriver.scala 67:38 68:44]
  wire [9:0] _GEN_4 = 8'h3 == rx_io_data ? 10'h17c : _GEN_2; // @[src/main/scala/MotorDriver.scala 68:44 72:52]
  wire  _GEN_5 = 8'h3 == rx_io_data ? 1'h0 : _GEN_3; // @[src/main/scala/MotorDriver.scala 67:38 68:44]
  wire [9:0] _GEN_6 = 8'h2 == rx_io_data ? 10'h3b6 : _GEN_4; // @[src/main/scala/MotorDriver.scala 68:44 71:52]
  wire  _GEN_7 = 8'h2 == rx_io_data ? 1'h0 : _GEN_5; // @[src/main/scala/MotorDriver.scala 67:38 68:44]
  wire [9:0] _GEN_8 = 8'h1 == rx_io_data ? 10'h280 : _GEN_6; // @[src/main/scala/MotorDriver.scala 68:44 70:52]
  wire  _GEN_9 = 8'h1 == rx_io_data ? 1'h0 : _GEN_7; // @[src/main/scala/MotorDriver.scala 67:38 68:44]
  wire [9:0] _GEN_10 = 8'h0 == rx_io_data ? 10'h200 : _GEN_8; // @[src/main/scala/MotorDriver.scala 68:44 69:52]
  wire  _GEN_11 = 8'h0 == rx_io_data | _GEN_9; // @[src/main/scala/MotorDriver.scala 68:44 69:75]
  wire  _GEN_12 = 8'h2 == cmdByte ? 1'h0 : control_mode; // @[src/main/scala/MotorDriver.scala 59:33 40:34 66:38]
  wire  _GEN_13 = 8'h2 == cmdByte ? _GEN_11 : manual_brake; // @[src/main/scala/MotorDriver.scala 59:33 41:34]
  wire [9:0] _GEN_14 = 8'h2 == cmdByte ? _GEN_10 : manual_speed; // @[src/main/scala/MotorDriver.scala 59:33 39:34]
  wire [7:0] _GEN_15 = 8'h1 == cmdByte ? rx_io_data : target_position; // @[src/main/scala/MotorDriver.scala 59:33 38:34 61:41]
  wire  _GEN_16 = 8'h1 == cmdByte | _GEN_12; // @[src/main/scala/MotorDriver.scala 59:33 62:41]
  wire  _GEN_17 = 8'h1 == cmdByte ? 1'h0 : _GEN_13; // @[src/main/scala/MotorDriver.scala 59:33 63:41]
  wire [9:0] _GEN_18 = 8'h1 == cmdByte ? manual_speed : _GEN_14; // @[src/main/scala/MotorDriver.scala 59:33 39:34]
  ...
  wire [1:0] _GEN_23 = 2'h2 == uartState ? 2'h0 : uartState; // @[src/main/scala/MotorDriver.scala 50:27 78:27 46:28]
  ...
  wire [42:0] _current_pos_m_T = rotation_counter_io_turns * 11'h576; // @[src/main/scala/MotorDriver.scala 88:52]
  wire [39:0] _current_pos_cm_T = rotation_counter_io_turns * 8'h88; // @[src/main/scala/MotorDriver.scala 89:53]
  wire [29:0] current_pos_cm = _current_pos_cm_T[39:10]; // @[src/main/scala/MotorDriver.scala 89:62]
  wire [7:0] _pid_io_setPoint_T = target_position; // @[src/main/scala/MotorDriver.scala 92:55]
  wire [22:0] _pid_io_measuredVal_T = _current_pos_m_T[42:20]; // @[src/main/scala/MotorDriver.scala 93:53]
  wire [31:0] _pid_duty_T = $signed(pid_io_controlOut) + 32'sh800; // @[src/main/scala/MotorDriver.scala 101:38]
  wire [31:0] _pid_duty_T_1 = {{2'd0}, _pid_duty_T[31:2]}; // @[src/main/scala/MotorDriver.scala 101:45]
  wire [9:0] pid_duty = _pid_duty_T_1[9:0]; // @[src/main/scala/MotorDriver.scala 101:63]
  wire  brake_active = stuck_detector_io_motorDisable | manual_brake; // @[src/main/scala/MotorDriver.scala 108:56]
  wire [18:0] modeLabel = control_mode ? 19'h57797 : 19'h7ab56; // @[src/main/scala/MotorDriver.scala 126:28]
  reg [23:0] txTimer; // @[src/main/scala/MotorDriver.scala 133:26]
  wire  _T_13 = ~tx_io_busy; // @[src/main/scala/MotorDriver.scala 137:14]
  wire [23:0] _txTimer_T_1 = txTimer + 24'h1; // @[src/main/scala/MotorDriver.scala 138:38]
  ...
  assign io_uart_tx = tx_io_tx; // @[src/main/scala/MotorDriver.scala 139:16]
  assign io_T1 = pwm_gen_io_T1; // @[src/main/scala/MotorDriver.scala 114:11]
  assign io_T2 = pwm_gen_io_T2; // @[src/main/scala/MotorDriver.scala 115:11]
  assign io_T3 = pwm_gen_io_T3; // @[src/main/scala/MotorDriver.scala 116:11]
  assign io_T4 = pwm_gen_io_T4; // @[src/main/scala/MotorDriver.scala 117:11]
  assign io_seg = disp_mux_io_seg; // @[src/main/scala/MotorDriver.scala 121:12]
  assign io_an = disp_mux_io_an; // @[src/main/scala/MotorDriver.scala 120:11]
  assign rx_clock = clock;
  assign rx_reset = reset;
  assign rx_io_rx = io_uart_rx; // @[src/main/scala/MotorDriver.scala 44:14]
  assign tx_clock = clock;
  assign tx_reset = reset;
  assign tx_io_data = current_pos_cm[7:0]; // @[src/main/scala/MotorDriver.scala 134:34]
  assign tx_io_start = txTimer >= 24'h4c4b40 & _T_13; // @[src/main/scala/MotorDriver.scala 135:17 136:32]
  assign rotation_counter_clock = clock;
  assign rotation_counter_reset = reset;
  assign rotation_counter_io_signal_A = filter_A_io_state; // @[src/main/scala/MotorDriver.scala 86:34]
  assign rotation_counter_io_signal_B = filter_B_io_state; // @[src/main/scala/MotorDriver.scala 87:34]
  assign pwm_gen_clock = clock;
  assign pwm_gen_reset = reset;
  assign pwm_gen_io_duty_cycle = control_mode ? pid_duty : manual_speed; // @[src/main/scala/MotorDriver.scala 110:33]
  assign pwm_gen_io_brake = stuck_detector_io_motorDisable | manual_brake; // @[src/main/scala/MotorDriver.scala 108:56]
  assign pid_clock = clock;
  assign pid_reset = reset;
  assign pid_io_setPoint = {{24{_pid_io_setPoint_T[7]}},_pid_io_setPoint_T}; // @[src/main/scala/MotorDriver.scala 92:24]
  assign pid_io_measuredVal = {{9{_pid_io_measuredVal_T[22]}},_pid_io_measuredVal_T}; // @[src/main/scala/MotorDriver.scala 93:24]
  assign pid_io_resetBuffer = ~control_mode | manual_brake; // @[src/main/scala/MotorDriver.scala 94:41]
  assign stuck_detector_clock = clock;
  assign stuck_detector_reset = reset;
  assign stuck_detector_io_externalOvercurrentInput = io_over_current_pos | io_over_current_neg; // @[src/main/scala/MotorDriver.scala 105:72]
  assign stuck_detector_io_clearShutdown = rx_io_done & cmdByte == 8'hff | error_clear_debounce_io_out; // @[src/main/scala/MotorDriver.scala 106:76]
  assign disp_mux_clock = clock;
  assign disp_mux_reset = reset;
  assign disp_mux_io_disp_content = brake_active ? 20'hdf2f8 : {{1'd0}, modeLabel}; // @[src/main/scala/MotorDriver.scala 123:25 124:34 129:34]
  assign filter_A_clock = clock;
  assign filter_A_reset = reset;
  assign filter_A_io_btn_in = io_photo_diode_A; // @[src/main/scala/MotorDriver.scala 84:24]
  assign filter_B_clock = clock;
  assign filter_B_reset = reset;
  assign filter_B_io_btn_in = io_photo_diode_B; // @[src/main/scala/MotorDriver.scala 85:24]
  assign error_clear_debounce_clock = clock;
  assign error_clear_debounce_reset = reset;
  assign error_clear_debounce_io_btn_in = io_error_cleared; // @[src/main/scala/MotorDriver.scala 104:36]
  always @(posedge clock) begin
    ...
    if (reset) begin // @[src/main/scala/MotorDriver.scala 46:28]
      ...
      if (2'h0 == uartState) begin // @[src/main/scala/MotorDriver.scala 50:27]
        if (rx_io_data == 8'haa) begin // @[src/main/scala/MotorDriver.scala 52:45]
          uartState <= 2'h1; // @[src/main/scala/MotorDriver.scala 52:57]
        end
      end else if (2'h1 == uartState) begin // @[src/main/scala/MotorDriver.scala 50:27]
        uartState <= 2'h2; // @[src/main/scala/MotorDriver.scala 56:27]
      end else begin
        uartState <= _GEN_23;
      end
    end
    if (reset) begin // @[src/main/scala/MotorDriver.scala 47:28]
      ...
      if (!(2'h0 == uartState)) begin // @[src/main/scala/MotorDriver.scala 50:27]
        if (2'h1 == uartState) begin // @[src/main/scala/MotorDriver.scala 50:27]
          cmdByte <= rx_io_data; // @[src/main/scala/MotorDriver.scala 55:27]
        end
      end
    end
    if (reset) begin // @[src/main/scala/MotorDriver.scala 133:26]
      txTimer <= 24'h0; // @[src/main/scala/MotorDriver.scala 133:26]
    end else if (txTimer >= 24'h4c4b40) begin // @[src/main/scala/MotorDriver.scala 136:32]
      if (~tx_io_busy) begin // @[src/main/scala/MotorDriver.scala 137:27]
        txTimer <= 24'h0; // @[src/main/scala/MotorDriver.scala 137:60]
      end
    end else begin
      txTimer <= _txTimer_T_1; // @[src/main/scala/MotorDriver.scala 138:27]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
