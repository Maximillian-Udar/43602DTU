...
`endif // RANDOMIZE_REG_INIT
  ...
  reg  rotations_io_signal_A_sync_REG; // @[src/main/scala/SecondDriver.scala 39:31]
  reg  rotations_io_signal_A_sync; // @[src/main/scala/SecondDriver.scala 39:23]
  reg [13:0] rotations_io_signal_A_cnt; // @[src/main/scala/SecondDriver.scala 40:23]
  reg  rotations_io_signal_A_out; // @[src/main/scala/SecondDriver.scala 41:23]
  wire [13:0] _rotations_io_signal_A_cnt_T_1 = rotations_io_signal_A_cnt + 14'h1; // @[src/main/scala/SecondDriver.scala 43:29]
  reg  rotations_io_signal_B_sync_REG; // @[src/main/scala/SecondDriver.scala 39:31]
  reg  rotations_io_signal_B_sync; // @[src/main/scala/SecondDriver.scala 39:23]
  reg [13:0] rotations_io_signal_B_cnt; // @[src/main/scala/SecondDriver.scala 40:23]
  reg  rotations_io_signal_B_out; // @[src/main/scala/SecondDriver.scala 41:23]
  wire [13:0] _rotations_io_signal_B_cnt_T_1 = rotations_io_signal_B_cnt + 14'h1; // @[src/main/scala/SecondDriver.scala 43:29]
  wire [63:0] current_position_fixed_point = $signed(rotations_io_turns) * 32'sh222; // @[src/main/scala/SecondDriver.scala 65:76]
  wire [51:0] current_position_cm = current_position_fixed_point[63:12]; // @[src/main/scala/SecondDriver.scala 66:59]
  reg [23:0] txTimer; // @[src/main/scala/SecondDriver.scala 139:24]
  reg [1:0] txState; // @[src/main/scala/SecondDriver.scala 141:24]
  wire  _T_16 = ~tx_io_busy; // @[src/main/scala/SecondDriver.scala 147:14]
  wire [7:0] _GEN_60 = ~tx_io_busy ? 8'hff : 8'h0; // @[src/main/scala/SecondDriver.scala 142:14 147:27 148:22]
  wire [7:0] _GEN_63 = _T_16 ? current_position_cm[15:8] : 8'h0; // @[src/main/scala/SecondDriver.scala 142:14 153:27 154:22]
  wire [1:0] _GEN_65 = _T_16 ? 2'h0 : txState; // @[src/main/scala/SecondDriver.scala 153:27 156:19 141:24]
  wire [23:0] _GEN_66 = _T_16 ? 24'h0 : txTimer; // @[src/main/scala/SecondDriver.scala 153:27 157:19 139:24]
  wire [7:0] _GEN_67 = _T_16 ? current_position_cm[7:0] : 8'h0; // @[src/main/scala/SecondDriver.scala 142:14 160:27 161:22]
  wire [7:0] _GEN_71 = 2'h2 == txState ? _GEN_67 : 8'h0; // @[src/main/scala/SecondDriver.scala 142:14 145:21]
  wire  _GEN_72 = 2'h2 == txState & _T_16; // @[src/main/scala/SecondDriver.scala 143:15 145:21]
  wire [1:0] _GEN_73 = 2'h2 == txState ? _GEN_65 : txState; // @[src/main/scala/SecondDriver.scala 145:21 141:24]
  wire [23:0] _GEN_74 = 2'h2 == txState ? _GEN_66 : txTimer; // @[src/main/scala/SecondDriver.scala 145:21 139:24]
  wire [7:0] _GEN_75 = 2'h1 == txState ? _GEN_63 : _GEN_71; // @[src/main/scala/SecondDriver.scala 145:21]
  wire  _GEN_76 = 2'h1 == txState ? _T_16 : _GEN_72; // @[src/main/scala/SecondDriver.scala 145:21]
  wire [7:0] _GEN_79 = 2'h0 == txState ? _GEN_60 : _GEN_75; // @[src/main/scala/SecondDriver.scala 145:21]
  wire  _GEN_80 = 2'h0 == txState ? _T_16 : _GEN_76; // @[src/main/scala/SecondDriver.scala 145:21]
  wire [23:0] _txTimer_T_1 = txTimer + 24'h1; // @[src/main/scala/SecondDriver.scala 168:36]
  ...
  assign io_uart_tx = tx_io_tx; // @[src/main/scala/SecondDriver.scala 169:14]
  assign io_T1 = 1'h0; // @[src/main/scala/SecondDriver.scala 126:25 127:11 132:11]
  assign io_T2 = 1'h1; // @[src/main/scala/SecondDriver.scala 126:25 128:11 133:11]
  assign io_T3 = 1'h0; // @[src/main/scala/SecondDriver.scala 126:25 129:11 134:11]
  assign io_T4 = 1'h1; // @[src/main/scala/SecondDriver.scala 126:25 130:11 135:11]
  assign io_seg = display_io_seg; // @[src/main/scala/SecondDriver.scala 173:10]
  assign io_an = display_io_an; // @[src/main/scala/SecondDriver.scala 172:9]
  assign tx_clock = clock;
  assign tx_reset = reset;
  assign tx_io_data = txTimer >= 24'h2625a0 ? _GEN_79 : 8'h0; // @[src/main/scala/SecondDriver.scala 142:14 144:30]
  assign tx_io_start = txTimer >= 24'h2625a0 & _GEN_80; // @[src/main/scala/SecondDriver.scala 143:15 144:30]
  assign display_clock = clock;
  assign display_reset = reset;
  assign rotations_clock = clock;
  assign rotations_reset = reset;
  assign rotations_io_signal_A = rotations_io_signal_A_out; // @[src/main/scala/SecondDriver.scala 49:25]
  assign rotations_io_signal_B = rotations_io_signal_B_out; // @[src/main/scala/SecondDriver.scala 50:25]
  always @(posedge clock) begin
    rotations_io_signal_A_sync_REG <= io_photo_sensor_A; // @[src/main/scala/SecondDriver.scala 39:31]
    rotations_io_signal_A_sync <= rotations_io_signal_A_sync_REG; // @[src/main/scala/SecondDriver.scala 39:23]
    if (reset) begin // @[src/main/scala/SecondDriver.scala 40:23]
      rotations_io_signal_A_cnt <= 14'h0; // @[src/main/scala/SecondDriver.scala 40:23]
    end else if (rotations_io_signal_A_sync == rotations_io_signal_A_out) begin // @[src/main/scala/SecondDriver.scala 42:24]
      rotations_io_signal_A_cnt <= 14'h0; // @[src/main/scala/SecondDriver.scala 42:30]
    end else begin
      rotations_io_signal_A_cnt <= _rotations_io_signal_A_cnt_T_1; // @[src/main/scala/SecondDriver.scala 43:22]
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 41:23]
      rotations_io_signal_A_out <= 1'h0; // @[src/main/scala/SecondDriver.scala 41:23]
    end else if (!(rotations_io_signal_A_sync == rotations_io_signal_A_out)) begin // @[src/main/scala/SecondDriver.scala 42:24]
      if (rotations_io_signal_A_cnt == 14'h2710) begin // @[src/main/scala/SecondDriver.scala 43:58]
        rotations_io_signal_A_out <= rotations_io_signal_A_sync; // @[src/main/scala/SecondDriver.scala 43:64]
      end
    end
    rotations_io_signal_B_sync_REG <= io_photo_sensor_B; // @[src/main/scala/SecondDriver.scala 39:31]
    rotations_io_signal_B_sync <= rotations_io_signal_B_sync_REG; // @[src/main/scala/SecondDriver.scala 39:23]
    if (reset) begin // @[src/main/scala/SecondDriver.scala 40:23]
      rotations_io_signal_B_cnt <= 14'h0; // @[src/main/scala/SecondDriver.scala 40:23]
    end else if (rotations_io_signal_B_sync == rotations_io_signal_B_out) begin // @[src/main/scala/SecondDriver.scala 42:24]
      rotations_io_signal_B_cnt <= 14'h0; // @[src/main/scala/SecondDriver.scala 42:30]
    end else begin
      rotations_io_signal_B_cnt <= _rotations_io_signal_B_cnt_T_1; // @[src/main/scala/SecondDriver.scala 43:22]
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 41:23]
      rotations_io_signal_B_out <= 1'h0; // @[src/main/scala/SecondDriver.scala 41:23]
    end else if (!(rotations_io_signal_B_sync == rotations_io_signal_B_out)) begin // @[src/main/scala/SecondDriver.scala 42:24]
      if (rotations_io_signal_B_cnt == 14'h2710) begin // @[src/main/scala/SecondDriver.scala 43:58]
        rotations_io_signal_B_out <= rotations_io_signal_B_sync; // @[src/main/scala/SecondDriver.scala 43:64]
      end
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 139:24]
      txTimer <= 24'h0; // @[src/main/scala/SecondDriver.scala 139:24]
    end else if (txTimer >= 24'h2625a0) begin // @[src/main/scala/SecondDriver.scala 144:30]
      if (!(2'h0 == txState)) begin // @[src/main/scala/SecondDriver.scala 145:21]
        if (2'h1 == txState) begin // @[src/main/scala/SecondDriver.scala 145:21]
          txTimer <= _GEN_66;
        end else begin
          txTimer <= _GEN_74;
        end
      ...
      txTimer <= _txTimer_T_1; // @[src/main/scala/SecondDriver.scala 168:25]
    end
    if (reset) begin // @[src/main/scala/SecondDriver.scala 141:24]
      txState <= 2'h0; // @[src/main/scala/SecondDriver.scala 141:24]
    end else if (txTimer >= 24'h2625a0) begin // @[src/main/scala/SecondDriver.scala 144:30]
      if (2'h0 == txState) begin // @[src/main/scala/SecondDriver.scala 145:21]
        if (~tx_io_busy) begin // @[src/main/scala/SecondDriver.scala 147:27]
          txState <= 2'h1; // @[src/main/scala/SecondDriver.scala 150:19]
        end
      end else if (2'h1 == txState) begin // @[src/main/scala/SecondDriver.scala 145:21]
        txState <= _GEN_65;
      end else begin
        txState <= _GEN_73;
      end
