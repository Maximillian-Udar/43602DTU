...
module RotationCounter(
  input         clock,
  input         reset,
  input         io_signal_A, // @[src/main/scala/Functions.scala 195:14]
  input         io_signal_B, // @[src/main/scala/Functions.scala 195:14]
  output [15:0] io_turns // @[src/main/scala/Functions.scala 195:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
  ...
  reg [31:0] _RAND_5;
`endif // RANDOMIZE_REG_INIT
  reg  aSync_REG; // @[src/main/scala/Functions.scala 201:30]
  reg  aSync; // @[src/main/scala/Functions.scala 201:22]
  reg  bSync_REG; // @[src/main/scala/Functions.scala 202:30]
  reg  bSync; // @[src/main/scala/Functions.scala 202:22]
  reg  aReg; // @[src/main/scala/Functions.scala 203:22]
  wire  rise_A = aSync & ~aReg; // @[src/main/scala/Functions.scala 204:22]
  reg [15:0] turns; // @[src/main/scala/Functions.scala 206:22]
  wire [15:0] _turns_T_1 = turns + 16'h1; // @[src/main/scala/Functions.scala 210:22]
  wire [15:0] _turns_T_3 = turns - 16'h1; // @[src/main/scala/Functions.scala 212:22]
  assign io_turns = turns; // @[src/main/scala/Functions.scala 215:12]
  always @(posedge clock) begin
    aSync_REG <= io_signal_A; // @[src/main/scala/Functions.scala 201:30]
    aSync <= aSync_REG; // @[src/main/scala/Functions.scala 201:22]
    bSync_REG <= io_signal_B; // @[src/main/scala/Functions.scala 202:30]
    bSync <= bSync_REG; // @[src/main/scala/Functions.scala 202:22]
    aReg <= aSync; // @[src/main/scala/Functions.scala 203:22]
    if (reset) begin // @[src/main/scala/Functions.scala 206:22]
      turns <= 16'h0; // @[src/main/scala/Functions.scala 206:22]
    end else if (rise_A) begin // @[src/main/scala/Functions.scala 208:16]
      if (~bSync) begin // @[src/main/scala/Functions.scala 209:18]
        turns <= _turns_T_1; // @[src/main/scala/Functions.scala 210:13]
      end else begin
        turns <= _turns_T_3; // @[src/main/scala/Functions.scala 212:13]
      end
    end
  end
// Register and memory initialization
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [63:0] _RAND_7;
`endif // RANDOMIZE_REG_INIT
  reg [15:0] errorReg; // @[src/main/scala/Functions.scala 163:25]
  reg [32:0] pTerm; // @[src/main/scala/Functions.scala 168:22]
  reg [31:0] iTermNext; // @[src/main/scala/Functions.scala 169:26]
  reg [15:0] prevErrorReg; // @[src/main/scala/Functions.scala 171:29]
  wire [15:0] _dTerm_T_2 = $signed(errorReg) - $signed(prevErrorReg); // @[src/main/scala/Functions.scala 172:41]
  reg [31:0] dTerm; // @[src/main/scala/Functions.scala 172:22]
  reg [15:0] integralReg; // @[src/main/scala/Functions.scala 177:28]
  wire [27:0] _GEN_1 = {$signed(integralReg), 12'h0}; // @[src/main/scala/Functions.scala 182:27]
  wire [31:0] _GEN_2 = {{4{_GEN_1[27]}},_GEN_1}; // @[src/main/scala/Functions.scala 182:27]
  wire [31:0] sum = $signed(_GEN_2) + $signed(iTermNext); // @[src/main/scala/Functions.scala 182:27]
  wire [31:0] _integralReg_T_2 = $signed(sum) < 32'sh0 ? $signed(32'sh0) : $signed(sum); // @[src/main/scala/Functions.scala 183:57]
  wire [31:0] _integralReg_T_3 = $signed(sum) > 32'sh1000000 ? $signed(32'sh1000000) : $signed(_integralReg_T_2); // @[src/main/scala/Functions.scala 183:23]
  wire [31:0] _GEN_0 = io_resetBuffer ? $signed(32'sh0) : $signed(_integralReg_T_3); // @[src/main/scala/Functions.scala 179:24 180:17 183:17]
  wire [32:0] _GEN_4 = {{5{_GEN_1[27]}},_GEN_1}; // @[src/main/scala/Functions.scala 187:33]
  wire [32:0] _rawOutput_T_2 = $signed(pTerm) + $signed(_GEN_4); // @[src/main/scala/Functions.scala 187:33]
  wire [32:0] _GEN_5 = {{1{dTerm[31]}},dTerm}; // @[src/main/scala/Functions.scala 187:47]
  reg [32:0] rawOutput; // @[src/main/scala/Functions.scala 187:26]
  reg [32:0] io_controlOut_REG; // @[src/main/scala/Functions.scala 190:27]
  wire [20:0] _GEN_6 = io_controlOut_REG[32:12]; // @[src/main/scala/Functions.scala 190:17]
  wire [19:0] _GEN_8 = reset ? $signed(20'sh0) : $signed(_GEN_0[31:12]); // @[src/main/scala/Functions.scala 177:{28,28}]
  assign io_controlOut = _GEN_6[15:0]; // @[src/main/scala/Functions.scala 190:17]
  always @(posedge clock) begin
    errorReg <= $signed(io_setPoint) - $signed(io_measuredVal); // @[src/main/scala/Functions.scala 163:38]
    pTerm <= -17'sh6000 * $signed(errorReg); // @[src/main/scala/Functions.scala 168:29]
    iTermNext <= 16'sh1000 * $signed(errorReg); // @[src/main/scala/Functions.scala 169:33]
    if (reset) begin // @[src/main/scala/Functions.scala 171:29]
      prevErrorReg <= 16'sh0; // @[src/main/scala/Functions.scala 171:29]
    end else begin
      prevErrorReg <= errorReg; // @[src/main/scala/Functions.scala 173:16]
    end
    dTerm <= 16'sh0 * $signed(_dTerm_T_2); // @[src/main/scala/Functions.scala 172:29]
    integralReg <= _GEN_8[15:0]; // @[src/main/scala/Functions.scala 177:{28,28}]
    rawOutput <= $signed(_rawOutput_T_2) + $signed(_GEN_5); // @[src/main/scala/Functions.scala 187:47]
    if ($signed(rawOutput) > 33'sh1000000) begin // @[src/main/scala/Functions.scala 188:25]
      io_controlOut_REG <= 33'sh1000000;
    end else if ($signed(rawOutput) < 33'sh0) begin // @[src/main/scala/Functions.scala 188:65]
...
module StuckDetector(
  input   clock,
  input   reset,
  input   io_externalOvercurrentInput, // @[src/main/scala/Functions.scala 220:14]
  input   io_clearShutdown, // @[src/main/scala/Functions.scala 220:14]
  output  io_motorDisable // @[src/main/scala/Functions.scala 220:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
`endif // RANDOMIZE_REG_INIT
  wire [24:0] maxCycles = 17'h186a0 * 8'hc8; // @[src/main/scala/Functions.scala 228:44]
  reg [31:0] durationReg; // @[src/main/scala/Functions.scala 229:28]
  reg  isStuckReg; // @[src/main/scala/Functions.scala 230:28]
  wire [31:0] _GEN_8 = {{7'd0}, maxCycles}; // @[src/main/scala/Functions.scala 238:26]
  wire [31:0] _durationReg_T_1 = durationReg + 32'h1; // @[src/main/scala/Functions.scala 241:38]
  wire  _GEN_0 = durationReg >= _GEN_8 | isStuckReg; // @[src/main/scala/Functions.scala 238:40 239:22 230:28]
  wire [31:0] _GEN_1 = durationReg >= _GEN_8 ? durationReg : _durationReg_T_1; // @[src/main/scala/Functions.scala 229:28 238:40 241:23]
  assign io_motorDisable = isStuckReg; // @[src/main/scala/Functions.scala 250:20]
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/Functions.scala 229:28]
      durationReg <= 32'h0; // @[src/main/scala/Functions.scala 229:28]
    end else if (io_clearShutdown) begin // @[src/main/scala/Functions.scala 232:26]
      durationReg <= 32'h0; // @[src/main/scala/Functions.scala 234:17]
    end else if (~isStuckReg) begin // @[src/main/scala/Functions.scala 236:23]
      if (io_externalOvercurrentInput) begin // @[src/main/scala/Functions.scala 237:41]
        durationReg <= _GEN_1;
      end else begin
        durationReg <= 32'h0; // @[src/main/scala/Functions.scala 244:21]
      end
    end
    if (reset) begin // @[src/main/scala/Functions.scala 230:28]
      isStuckReg <= 1'h0; // @[src/main/scala/Functions.scala 230:28]
    end else if (io_clearShutdown) begin // @[src/main/scala/Functions.scala 232:26]
      isStuckReg <= 1'h0; // @[src/main/scala/Functions.scala 233:17]
    end else if (~isStuckReg) begin // @[src/main/scala/Functions.scala 236:23]
      if (io_externalOvercurrentInput) begin // @[src/main/scala/Functions.scala 237:41]
        isStuckReg <= _GEN_0;
      end
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [26:0] scaled_turns; // @[src/main/scala/MotorDriver.scala 73:31]
  reg [6:0] current_pos_m; // @[src/main/scala/MotorDriver.scala 74:32]
  wire [7:0] _pid_io_setPoint_T = target_position; // @[src/main/scala/MotorDriver.scala 77:55]
  wire [6:0] _pid_io_measuredVal_T = current_pos_m; // @[src/main/scala/MotorDriver.scala 78:53]
  ...
  reg [9:0] pwm_gen_io_duty_cycle_REG; // @[src/main/scala/MotorDriver.scala 96:37]
  ...
  assign tx_io_data = {{1'd0}, current_pos_m}; // @[src/main/scala/MotorDriver.scala 109:17]
  ...
  assign pwm_gen_io_duty_cycle = pwm_gen_io_duty_cycle_REG; // @[src/main/scala/MotorDriver.scala 96:27]
  ...
  assign pid_io_measuredVal = {{9{_pid_io_measuredVal_T[6]}},_pid_io_measuredVal_T}; // @[src/main/scala/MotorDriver.scala 78:24]
  ...
  always @(posedge clock) begin
    ...
    scaled_turns <= rotation_counter_io_turns * 11'h576; // @[src/main/scala/MotorDriver.scala 73:58]
    current_pos_m <= scaled_turns[26:20]; // @[src/main/scala/MotorDriver.scala 74:46]
    if (control_mode) begin // @[src/main/scala/MotorDriver.scala 96:41]
      if (pid_duty_raw > 14'h3ff) begin // @[src/main/scala/MotorDriver.scala 89:27]
