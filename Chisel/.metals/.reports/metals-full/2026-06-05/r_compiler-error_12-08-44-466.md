error id: F70871CC31DB72F19B0A575031925185
...
parent      =  extends Bundle {
  ...
  val toggle_alarm1 = Input(Bool())
  val toggle_alarm2 = Input(Bool())
  val alarm1_minute_up = Input(Bool())
  val alarm1_hour_up = _root_.scala.Predef.???
} # -1,
parent span = <109..360>,
child       = val alarm1_hour_up = _root_.scala.Predef.??? # -1,
child span  = [342..346..361]
