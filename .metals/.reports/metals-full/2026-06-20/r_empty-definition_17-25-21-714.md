error id: file://<WORKSPACE>/Chisel/src/main/scala/Functions.scala:RegEnable.
...
// Pipelined PID for FP calculations
class PIDController(val w: Int = 32, val f: Int = 12) extends Module {
  ...
  val iInc_s1  = RegE@@nable(io.ki * error, tick_s1)
