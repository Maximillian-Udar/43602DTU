error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/Driver.scala:moving_requested.
file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/Driver.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/encoder_stuck/io/moving_requested.
	 -chisel3/encoder_stuck/io/moving_requested#
	 -chisel3/encoder_stuck/io/moving_requested().
	 -chisel3/util/encoder_stuck/io/moving_requested.
	 -chisel3/util/encoder_stuck/io/moving_requested#
	 -chisel3/util/encoder_stuck/io/moving_requested().
	 -encoder_stuck/io/moving_requested.
	 -encoder_stuck/io/moving_requested#
	 -encoder_stuck/io/moving_requested().
	 -scala/Predef.encoder_stuck.io.moving_requested.
	 -scala/Predef.encoder_stuck.io.moving_requested#
	 -scala/Predef.encoder_stuck.io.moving_requested().
offset: 5499
...
class Driver(Kp: Double, Ki: Double, Kd: Double, PWM_frequency: Int = 30000, manual_speed_step_ms: Int = 2) extends Module {
  ...
  val encoder_stuck        = Module(new EncoderStuckDetector(1000))
  ...
  // Encoder stuck
  val is_driving = system_active && !at_position && !manual_brake && (active_duty =/= 512.U)
  encoder_stuck.io.movi@@ng_requested := is_driving
