error id: file://<WORKSPACE>/Chisel/src/main/scala/Functions.scala:
file://<WORKSPACE>/Chisel/src/main/scala/Functions.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/external_overcurrent_input.
	 -chisel3/external_overcurrent_input#
	 -chisel3/external_overcurrent_input().
	 -chisel3/util/external_overcurrent_input.
	 -chisel3/util/external_overcurrent_input#
	 -chisel3/util/external_overcurrent_input().
	 -external_overcurrent_input.
	 -external_overcurrent_input#
	 -external_overcurrent_input().
	 -scala/Predef.external_overcurrent_input.
	 -scala/Predef.external_overcurrent_input#
	 -scala/Predef.external_overcurrent_input().
offset: 5559
uri: file://<WORKSPACE>/Chisel/src/main/scala/Functions.scala
text:
```scala
import chisel3._
...
class StuckDetector(val OverCurrentAllowance_ms : Int = 150) extends Module {
  val io = IO(new Bundle {
      val external_ov@@ercurrent_input = Input(Bool())      
