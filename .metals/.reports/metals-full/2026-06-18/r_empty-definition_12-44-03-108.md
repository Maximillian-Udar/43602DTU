error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/MotorDriver.scala:when.
...
class MotorDriver(KP: Double, KI: Double, KD: Double) extends Module {
  ...
  val debounce_A       = Module(new Debouncer(100))
  val debounce_B       = Module(new Debouncer(100))
  ...
  // --- Encoder Math ---
  rotation_counter.io.signal_A := debounce_A.io.out
  rotation_counter.io.signal_B := debounce_B.io.out
