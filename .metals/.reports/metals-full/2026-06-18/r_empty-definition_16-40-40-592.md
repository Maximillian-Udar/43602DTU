error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/Functions.scala:when.
...
class PIDController(val w: Int, val f: Int) extends Module {
  ...
  @@when(io.resetBuffer) {
    ...
    outputReg    := Mux(rawOutput_s3 > limit_pos, limit_pos, Mux(rawOutput_s3 < limit_neg, limit_neg, rawOutput_s3))
  }
