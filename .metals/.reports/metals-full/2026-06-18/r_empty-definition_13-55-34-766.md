error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/SecondDriver.scala:controlOut.
file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/SecondDriver.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/pid/io/controlOut.
	 -chisel3/pid/io/controlOut#
	 -chisel3/pid/io/controlOut().
	 -chisel3/util/pid/io/controlOut.
	 -chisel3/util/pid/io/controlOut#
	 -chisel3/util/pid/io/controlOut().
	 -pid/io/controlOut.
	 -pid/io/controlOut#
	 -pid/io/controlOut().
	 -scala/Predef.pid.io.controlOut.
	 -scala/Predef.pid.io.controlOut#
	 -scala/Predef.pid.io.controlOut().
offset: 4345
...
class SecondDriver(Kp: Double, Ki: Double, Kd: Double) extends Module {
        ...
        switch(CMDByte) {
          ...
          is(0x02.U) { 
            ...
            switch(rx.io.data) {
              ...
              is(0.U) { manual_speed := 512.U  }
              is(1.U) { manual_speed := 650.U; manual_brake := false.B } // s_fwd
              is(2.U) { manual_speed := 752.U; manual_brake := false.B } // f_fwd
              is(3.U) { manual_speed := 400.U; manual_brake := false.B } // s_back
  ...
  val pid_duty_raw = ((pid.io.controlO@@ut + 0.5.F(pidDP.BP)).asUInt >> (pidDP-10).U)
