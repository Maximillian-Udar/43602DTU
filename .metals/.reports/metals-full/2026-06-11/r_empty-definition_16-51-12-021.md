error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/Functions.scala:
...
class DCMotorPwm(pwmFreqHz: Int = 30000) extends Module {
  ...
  when(io.brake) {
    conduct_T1 := true.B  // NMOS ON
    conduct_T2 := false.B // PMOS OFF
    conduct_T3 := true.B  // NMOS ON
    conduct_T4 := false.B // PMOS OFF
  } .otherwise {
