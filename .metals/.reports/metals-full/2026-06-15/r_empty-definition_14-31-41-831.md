error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/MotorDriver.scala:Module.
...
class MotorDriver extends Module {
    ...
    pid.io.setPoint    := target_position(3, 0).asFixedPoint(12.BP)
    pid.io.measuredVal := current_pos_m(3, 0).asFixedPoint(12.BP)
    pid.io.resetBuffer := !control_mode || manual_brake
    
    pid.io.kp := 80.F(16.W, 12.BP)
    pid.io.ki := 0.F(16.W, 12.BP)
    pid.io.kd := 1.F(16.W, 12.BP)

    val half_const = FixedPoint.fromDouble(0.5, 16.W, 12.BP)
