error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/Driver.scala:when.
...
class Driver(Kp: Double, Ki: Double, Kd: Double, PWM_frequency: Int = 30000, manual_speed_step_ms: Int = 2) extends Module {
  ...
  */
  ...
  pwm_signal.io.duty_cycle := RegInit(512.U(10.W))
  pwm_signal.io.duty_cycle := Mux(block_neg || block_pos, 512.U, active_duty)
