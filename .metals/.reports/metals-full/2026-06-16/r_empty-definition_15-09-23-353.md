error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/MotorDriver.scala:RegInit.
...
non-local guesses:
	 ...
	 -chisel3/RegInit#
	 -chisel3/RegInit().
	 -chisel3/util/RegInit.
	 -chisel3/util/RegInit#
	 -chisel3/util/RegInit().
	 -RegInit.
	 -RegInit#
	 -RegInit().
	 -scala/Predef.RegInit.
	 -scala/Predef.RegInit#
	 -scala/Predef.RegInit().
offset: 1805
...
class MotorDriver(KP : Int, KI: Int, KD: Int) extends Module {
    ...
    val control_mode    = R@@egInit(true.B)
            ...
            switch(cmdByte) {
                ...
                is(0x02.U) { 
                    ...
                    switch(rx.io.data) {
                        ...
                        is(1.U) { manual_speed := 614.U; manual_brake := false.B }
                        is(2.U) { manual_speed := 715.U; manual_brake := false.B }
                        is(3.U) { manual_speed := 409.U; manual_brake := false.B }
                        is(4.U) { manual_speed := 300.U; manual_brake := false.B }
