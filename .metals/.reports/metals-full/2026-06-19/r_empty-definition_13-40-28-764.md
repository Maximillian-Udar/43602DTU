error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/SecondDriver.scala:is.
        ...
        switch(CMDByte) {
          ...
          is(0x02.U) { 
            ...
            switch(rx.io.data) {
              ...
              is(2.U) { manual_speed := 700.U; manual_brake := false.B }
              is(3.U) { manual_speed := 374.U; manual_brake := false.B }
              is(4.U) { manual_speed := 324.U; manual_brake := false.B }
            }
          }
