error id: file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/SecondDriver.scala:io.
file:///C:/Users/maxim/43602DTU/Chisel/src/main/scala/SecondDriver.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/stuck_detector/io.
	 -chisel3/util/stuck_detector/io.
	 -stuck_detector/io.
	 -scala/Predef.stuck_detector.io.
offset: 3985
...
class SecondDriver(Kp: Double, Ki: Double, Kd: Double) extends Module {
      ...
      is(sValue) {
        switch(CMDByte) {
          ...
          is(0x02.U) { 
            ...
            manual_brake := false.B
            switch(rx.io.data) {
              is(0.U) { manual_brake := true.B } // Brake
              is(1.U) { manual_speed := 550.U; manual_brake := false.B } // sf
              is(2.U) { manual_speed := 600.U; manual_brake := false.B } // ff
              is(3.U) { manual_speed := 470.U; manual_brake := false.B } // sb
              is(4.U) { manual_speed := 400.U; manual_brake := false.B } // fb
            }
          }
  ...
  stuck_detector.i@@o.clear_shutdown := (error_clear_debounce.io.out || reset_triggered)
